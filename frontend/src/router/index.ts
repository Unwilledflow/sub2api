...
const routes: RouteRecordRaw[] = [
  ...
  },
  {
    ...
    name: 'AdminOAuthAccounts',
    component: () => import('@/views/admin/OAuthAccountsView.vue'),
    meta: {
      requiresAuth: true,
      requiresAdmin: true,
      title: 'OAuth Accounts',
      titleKey: 'admin.oauthAccounts.title',
      descriptionKey: 'admin.oauthAccounts.description'
    }
  },
  {
    path: '/admin/plugins',
