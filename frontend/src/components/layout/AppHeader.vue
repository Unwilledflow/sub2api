<template>
  <header class="glass sticky top-0 z-30 border-b border-gray-200/60 backdrop-blur-xl dark:border-dark-700/40">
    <div class="flex h-16 items-center justify-between gap-2 px-2 sm:px-4 md:px-6">
      ...
      <div class="flex shrink-0 items-center gap-2 sm:gap-4">
        ...
        <div class="hidden lg:block">
          ...
          <p v-if="pageDescription" class="text-xs text-gray-600 dark:text-dark-300">
            {{ pageDescription }}
          </p>
        </div>
      </div>
      ...
      <div class="flex min-w-0 items-center gap-1 sm:gap-3">
        ...
        <a
          ...
          class="hidden items-center gap-1.5 rounded-lg px-3 py-2 text-sm font-medium text-gray-700 transition-all hover:bg-gray-100/80 hover:text-gray-900 dark:text-dark-300 dark:hover:bg-dark-800/80 dark:hover:text-white sm:flex"
        >
        ...
        <router-link
          ...
          class="hidden items-center gap-1.5 rounded-lg px-3 py-2 text-sm font-medium text-primary-700 transition-all hover:bg-primary-50 hover:text-primary-900 dark:text-primary-300 dark:hover:bg-primary-900/20 dark:hover:text-primary-200 sm:flex"
        >
        ...
        <div
          v-if="user"
          class="group relative hidden items-center gap-2 rounded-xl bg-gradient-to-br from-primary-50 to-primary-100/50 px-3.5 py-2 shadow-sm ring-1 ring-primary-200/40 transition-all hover:shadow-md dark:from-primary-900/30 dark:to-primary-950/20 dark:ring-primary-800/30 sm:flex"
        >
          <svg
          ...
          <span
            ...
            class="rounded-full bg-amber-100 px-2 py-0.5 text-xs font-medium text-amber-800 shadow-sm dark:bg-amber-900/50 dark:text-amber-200"
          >
            {{ balanceFrozenLabel }}
          </span>
          <div
