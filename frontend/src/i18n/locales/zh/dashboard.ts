export default {
  ...
  "keys": {
    ...
    "fallbackGroupsLabel": "Fallback 优先顺序",
    "clearFallbackGroups": "清空",
    "availableFallbackGroups": "可选分组",
    "lowestRateFirst": "默认最低实际倍率优先",
    "noFallbackGroups": "暂无可用的 fallback 分组",
    "fallbackGroupsHint": "Fallback 将按保存的优先顺序依次尝试。",
    "adaptiveRoutingLabel": "Adaptive 路由偏好",
    "adaptiveRoutingIntelligence": "智力优先",
    "adaptiveRoutingPrice": "价格优先",
    "adaptiveBudgetLabel": "预算限制（最高倍率）",
    "adaptiveBudgetPlaceholder": "留空不限制，例如 0.11",
    "adaptiveBudgetHint": "排除倍率高于该值的叶子分组。例如填 0.11 则不会使用 0.22 兜底组。",
    "antiStallLabel": "Anti-Stall PRO（抗中断）",
    "antiStallHint": "流式中断时缓存 Token 缓速吐出并自动切叶子；有新数据时立即恢复正常速度。参数由管理员按档位配置。",
    "antiStallOff": "关闭",
    "antiStallBasic": "Basic",
    "antiStallPro": "Pro",
    "antiStallUltra": "Ultra",
    "moveFallbackUp": "提高优先级",
    "moveFallbackDown": "降低优先级",
    "removeFallbackGroup": "移除 fallback 分组",
    "blockOpenAIFast": "阻断 OpenAI Fast"
  },
  "usage": {
    "title": "使用记录",
    ...
    "onlyMismatches": "仅看模型不一致",
    "upstreamFailed": "上游失败用量"
  },
  "monitorCommon": {
    "status": {
      "operational": "正常",
  ...
  "channelStatus": {
    ...
    "liveLabel": "实时服务状态",
    "systemHealth": "当前系统健康度",
    "windowLabel": "可用率统计周期",
    "updated": "更新于 {time}",
    "waitingForProbe": "等待首次检测",
    "healthHeadline": {
      "operational": "全部服务运行良好",
      "degraded": "部分服务需要关注",
      "unavailable": "正在建立监控状态"
    },
    "metrics": {
      "groups": "监控分组",
      "models": "监控模型",
    ...
    "channelsKicker": "渠道与模型",
    "channelsTitle": "服务可用性",
    "channelsSummary": "{groups} 个渠道 · {models} 个模型",
    "latencyShort": "延迟",
    "availabilityShort": "可用率",
    "recentKicker": "近期更新",
    "recentTitle": "最近状态记录",
    "recentCount": "显示 {n} 条",
    "noRecentEvents": "完成首次检测后将在这里显示状态记录。",
    "eventLatency": " · 延迟 {n} ms",
    "eventChanged": "{from} → {to}{latency}",
    "eventChecked": "状态确认为 {status}{latency}",
    "filterByStatus": "按健康状态筛选",
    "filterAll": "全部",
    "noMatchTitle": "没有匹配的渠道",
    "noMatchDescription": "试试调整搜索或筛选条件",
    "filteredFrom": "共 {n} 个",
    "showMore": "展开其余 {n} 个模型",
    "showLess": "收起",
    "groupNodes": "{n} 个检测节点",
    "overallHealthy": "健康 {healthy}/{total}"
  },
  "availableChannels": {
    "title": "可用渠道",
  ...
  "groupMonitor": {
    ...
    "ref": {
      ...
      "filtered": "已筛选",
      "filterNone": "未筛选",
      "searchPlaceholder": "搜索分组、模型",
      "refresh": "刷新",
      "past": "过去",
      "now": "现在"
    },
    "emptyTitle": "暂无分组监控",
    "emptyDescription": "管理员尚未配置分组监控，配置后即可在此查看。"
  },
  "modelMarketplace": {
    "badge": "模型与价格总览",
    "title": "模型广场",
    "description": "按模型聚合查看你可访问的渠道、平台、分组和上游模型价格，包含输入、输出与缓存价格。",
    "search": "搜索",
    "searchPlaceholder": "搜索模型、家族、平台或渠道...",
    "filters": "筛选",
    "clear": "清空",
    "platform": "平台",
    "allPlatforms": "全部平台",
    ...
    "groupView": "可见分组",
    "bestGroupView": "全部可见分组",
    "groupViewActive": "{group}",
    "unpriced": "暂无上游价格",
    "exclusiveOnly": "仅看包含专属分组的模型",
    "exclusiveOnlyShort": "专属分组",
    "tieredOnly": "仅看阶梯定价模型",
    "tieredOnlyShort": "阶梯定价",
    "expandFilters": "展开筛选",
    ...
    "sortChannelsDesc": "渠道数最多",
    "resultCount": "共 {count} 个模型",
    "resultSummary": "显示 {shown} / {total} 个模型",
    "cardView": "卡片",
    "tableView": "表格",
    "tableScrollHint": "表格可左右滑动查看完整价格和渠道信息",
    "empty": "暂无匹配模型",
    "emptyFilteredHint": "当前筛选条件没有命中模型，可以清空筛选或换一个关键词。",
    "emptyNoModels": "暂无可展示模型",
    "emptyNoModelsHint": "请确认渠道已启用、已绑定有效分组，并在渠道定价或模型映射里配置具体模型。",
    "reload": "重新加载",
    "loadFailed": "模型目录加载失败",
    "loadFailedHint": "模型与价格服务暂未返回数据，请重试加载最新渠道目录。",
    "stats": {
      "models": "模型",
      "platforms": "平台",
      "channels": "渠道"
    ...
    "insights": {
      "bestValue": "低输入价模型",
      "bestValueHelper": "输入价 {price}",
      "exclusive": "专属可见",
      "exclusiveHelper": "点击查看限定分组",
      "noTokenPricing": "暂无 token 定价",
      "noData": "暂无模型数据"
    },
    "model": "模型",
    "channels": "渠道",
    ...
    "cacheShort": "缓存",
    "perRequestShort": "/ 请求",
    "adjustedInput": "输入价格（分组后）",
    "adjustedOutput": "输出价格（分组后）",
    "adjustedCacheWrite": "缓存写入（分组后）",
    "adjustedCacheRead": "缓存读取（分组后）",
    "priceBreakdownTitle": "渠道模型价格",
    "priceBreakdownHint": "展示价格来自上游渠道模型定价。",
    "upstreamPrice": "上游模型价格",
    "upstreamPriceHint": "来自渠道模型定价，未乘分组倍率。",
    "groupAdjustedPrice": "分组倍率后价格",
    "groupAdjustedHint": "按你可用分组倍率乘上游价格后的实际展示价。",
    "rateFormula": "上游价 × 分组倍率",
    "upstreamShort": "上游",
    "groupAdjustedShort": "分组后",
    "customRate": "专属",
    "cacheWrite": "缓存写入",
    "cacheRead": "缓存读取",
    "perRequest": "单次请求",
    ...
    "details": "详情",
    "detailTitle": "模型详情",
    "quickStart": "OpenAI 兼容调用示例",
    "requestBody": "请求体",
    "curlCommand": "curl",
    "copyJson": "复制 JSON",
    "copyCurl": "复制 curl",
    "requestCopied": "请求体已复制",
