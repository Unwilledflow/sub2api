  ...
  "accounts": {
    ...
    "oauth": {
      ...
      "openai": {
        ...
        "codexSessionSelectFile": "选择 JSON 文件",
        "codexSessionFileTooLarge": "文件不能超过 10MB",
        "codexSessionFileEmpty": "所选文件为空",
        "codexSessionFileReadFailed": "读取文件失败，请重新选择"
      },
      "grok": {
        "title": "Grok 账号授权",
    ...
    "oauthPage": {
      ...
      "description": "集中管理 OAuth 导入账号",
      "search": "搜索名称、邮箱或账号 ID",
      "statusFilter": "状态筛选",
      "total": "共 {count} 个账号",
      "selected": "已选 {count}",
      "invalid": "无效 {count}",
      ...
      "testFailed": "检测失败",
      "testSkipped": "已跳过",
      "batchTestSuccess": "批量检测完成：{success} 个账号通过",
      "batchTestPartial": "批量检测完成：通过 {success}，失败 {failed}，跳过 {skipped}",
      "deleteSelected": "删除所选",
      "deleteInvalid": "删除无效账号",
      "selectPage": "选择当前页",
      "selectAccount": "选择账号 {name}",
      "plan": "套餐 / 关系",
      "planUnknown": "未识别套餐",
      "shadowOf": "影子账号，母账号 #{id}",
      "ungrouped": "未分组",
      "empty": "没有符合条件的 OpenAI OAuth 账号",
      "deleteConfirmTitle": "确认删除 OAuth 账号",
      "deleteSingleConfirm": "确认删除账号“{name}”？",
      "deleteSelectedConfirm": "确认删除选中的 {count} 个 OAuth 账号？",
      "deleteInvalidConfirm": "确认删除检测到的 {count} 个永久失效 OAuth 账号？临时错误、限流和策略拦截账号会保留。",
      "deleteSuccess": "已删除 {count} 个 OAuth 账号",
      "deletePartial": "删除 {deleted} 个，失败 {failed} 个，跳过 {skipped} 个"
    }
  }
}
