export default {
  "settings": {
    ...
    "registration": {
      ...
      "emailSuffixWhitelistHint": "仅允许使用指定域名的邮箱注册账号；留空则不限制（例如 {'@'}qq.com, {'@'}gmail.com, *.edu.cn）",
      ...
      "emailDomainQuotaHint": "开启后，白名单非空时，其他可注册主域名各限注册一个账户；关闭时非白名单域名直接拒绝注册。白名单为空时本开关无效果",
      "promoCode": "优惠码",
    ...
    "payment": {
      ...
      "limitDevice": "服务终端",
      "limitDeviceAny": "不限",
      "limitDeviceMobile": "仅移动端",
      "limitDeviceDesktop": "仅桌面端"
    },
    "balanceNotify": {
      "title": "余额不足提醒",
