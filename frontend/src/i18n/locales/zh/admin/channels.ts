export default {
  ...
  "channelMonitor": {
    ...
    "statusFilter": "健康状态",
    "statusFilterAll": "全部健康状态",
    "autoRefresh": "自动刷新",
    "autoRefreshHint": "每 30 秒静默刷新列表（打开弹窗时暂停）",
    "lastRefreshed": "更新于 {time}",
    "runResultEmpty": "没有检测结果",
    "noMatchTitle": "没有匹配的监控",
    "noMatchDescription": "试试调整筛选条件，或清除状态筛选",
    "summary": {
      "all": "全部",
      "allHint": "当前列表总数",
      "operational": "正常",
  ...
  "groupMonitor": {
    ...
    "runFailed": "检测失败",
    "delete": "删除",
    "deleteConfirm": "确定删除分组监控「{name}」吗？",
    "deleteSuccess": "分组监控已删除",
    "createSuccess": "分组监控创建成功",
    "updateSuccess": "分组监控更新成功",
    "batchCreateSuccess": "已创建 {created} 个分组监控，跳过 {skipped} 个已存在的分组",
    "loadError": "加载失败",
    "noMonitors": "暂无分组监控",
    "noMonitorsDesc": "创建一个分组监控，自动检测组内所有账号的健康状态",
    "accounts": "账号",
    "healthy": "健康",
    "failed": "异常",
    "unknown": "未知",
