export default {
  ...
  "auth": {
    ...
    "oidc": {
      ...
      "completing": "正在完成注册...",
      "completeRegistrationFailed": "注册失败，请检查邀请码后重试。",
      "signUp": "使用 {providerName} 注册",
      "registrationTitle": "使用统一身份创建账户",
      "registrationDescription": "通过 {providerName} 完成身份验证并创建账户",
      "registrationIdentity": "统一身份认证"
    },
    "oauthFlow": {
