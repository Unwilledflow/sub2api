export default {
  ...
  "keys": {
    ...
    "fallbackGroupsLabel": "Fallback priority",
    "clearFallbackGroups": "Clear",
    "availableFallbackGroups": "Available groups",
    "lowestRateFirst": "Lowest effective rate first",
    "noFallbackGroups": "No fallback groups available",
    "fallbackGroupsHint": "Fallback attempts use the saved priority order.",
    "adaptiveRoutingLabel": "Adaptive routing preference",
    "adaptiveRoutingIntelligence": "Intelligence first",
    "adaptiveRoutingPrice": "Price first",
    "adaptiveBudgetLabel": "Budget limit (max rate)",
    "adaptiveBudgetPlaceholder": "Empty = unlimited, e.g. 0.11",
    "adaptiveBudgetHint": "Exclude Adaptive leaves with rate strictly above this value. Example: 0.11 skips a 0.22 leaf.",
    "antiStallLabel": "Anti-Stall PRO",
    "antiStallHint": "On stream interrupt, hold-back tokens drip slowly and Adaptive may switch leaves. New upstream data exits drip immediately. Tier params are set by admin.",
    "antiStallOff": "Off",
    "antiStallBasic": "Basic",
    "antiStallPro": "Pro",
    "antiStallUltra": "Ultra",
    "moveFallbackUp": "Move up",
    "moveFallbackDown": "Move down",
    "removeFallbackGroup": "Remove fallback group",
    "blockOpenAIFast": "Block OpenAI Fast"
  },
  "usage": {
    "title": "Usage Records",
    ...
    "onlyMismatches": "Mismatches only",
    "upstreamFailed": "Upstream failed usage"
  },
  "monitorCommon": {
    "status": {
  ...
  "channelStatus": {
    ...
    "liveLabel": "Live service status",
    "systemHealth": "Current system health",
    "windowLabel": "Availability window",
    "updated": "Updated {time}",
    "waitingForProbe": "Waiting for the first probe",
    "healthHeadline": {
      "operational": "All services are operating normally",
      "degraded": "Some services need attention",
      "unavailable": "Establishing monitor status"
    },
    "metrics": {
      "groups": "Groups",
      "models": "Models",
    ...
    "channelsKicker": "Channels and models",
    "channelsTitle": "Service availability",
    "channelsSummary": "{groups} channels · {models} models",
    "latencyShort": "Latency",
    "availabilityShort": "Availability",
    "recentKicker": "Recent updates",
    "recentTitle": "Latest status records",
    "recentCount": "{n} shown",
    "noRecentEvents": "Status records will appear after the first probe completes.",
    "eventLatency": " · {n} ms latency",
    "eventChanged": "{from} → {to}{latency}",
    "eventChecked": "Status confirmed as {status}{latency}",
    "filterByStatus": "Filter by health",
    "filterAll": "All",
    "noMatchTitle": "No matching channels",
    "noMatchDescription": "Try adjusting search or filters",
    "filteredFrom": "of {n} total",
    "showMore": "Show {n} more models",
    "showLess": "Show less",
    "groupNodes": "{n} probe nodes",
    "overallHealthy": "{healthy}/{total} healthy"
  },
  "availableChannels": {
  ...
  "groupMonitor": {
    "overview": {
      "kicker": "Group Monitor",
      "title": "Group Health",
      "description": "Real-time health overview of accounts across groups",
      "refresh": "Refresh",
    ...
    "card": {
      ...
      "latency": "Latency",
      "history": "History",
      "accountBar": "Account distribution",
      "probes": "probes",
      "cacheShort": "cache",
      "noData": "No data",
      "noProbes": "No probes in this period",
      "model": "Model",
      "modelAuto": "Model auto-selected",
      "notChecked": "Not checked yet",
      "justNow": "Just now",
      "minutesAgo": "{n}m ago",
      "hoursAgo": "{n}h ago",
      "healthyLabel": "Healthy {n}",
      "failedLabel": "Failed {n}",
      "unknownLabel": "Unknown {n}"
    },
    ...
    "ref": {
      ...
      "availability": "Availability",
      "days": "7d",
      "records": "Last 60 records",
      "samples": "Last 60 status samples",
      "consecutiveSuccess": "Consecutive success: {n}",
      ...
      "filtered": "Filtered",
      "filterNone": "None",
      "searchPlaceholder": "Search groups, models",
      "refresh": "Refresh",
      "past": "Past",
      "now": "Now"
    },
    "emptyTitle": "No group monitors",
    "emptyDescription": "No group monitors configured yet. They will appear here once configured."
  },
  "modelMarketplace": {
    "badge": "Model and pricing overview",
    "title": "Model Marketplace",
    "description": "Browse accessible models by channel, platform, group and upstream pricing, including input, output and cache prices.",
    "search": "Search",
    "searchPlaceholder": "Search models, families, platforms or channels...",
    "filters": "Filters",
    "clear": "Clear",
    "platform": "Platform",
    ...
    "groupView": "Visible group",
    "bestGroupView": "All visible groups",
    "groupViewActive": "{group}",
    "unpriced": "No upstream price",
    "exclusiveOnly": "Only models with exclusive groups",
    "exclusiveOnlyShort": "Exclusive groups",
    "tieredOnly": "Only models with tiered pricing",
    "tieredOnlyShort": "Tiered pricing",
    ...
    "sortChannelsDesc": "Most channels",
    "resultCount": "{count} models",
    "resultSummary": "{shown} of {total} models",
    "cardView": "Cards",
    "tableView": "Table",
    "tableScrollHint": "Swipe horizontally to view all pricing and channel columns",
    "empty": "No matching models",
    "emptyFilteredHint": "No model matches the current filters. Clear filters or try a different keyword.",
    "emptyNoModels": "No models to show yet",
    "emptyNoModelsHint": "Make sure channels are active, bound to active groups, and have concrete models in pricing or model mapping.",
    "reload": "Reload",
    "loadFailed": "Model catalog failed to load",
    "loadFailedHint": "The model and pricing service did not return data. Retry to reload the latest channel catalog.",
    "stats": {
      "models": "Models",
      "platforms": "Platforms",
      "channels": "Channels"
    ...
    "insights": {
      "bestValue": "Low input price",
      "bestValueHelper": "Input {price}",
      "exclusive": "Exclusive access",
      "exclusiveHelper": "Click to view limited groups",
      "noTokenPricing": "No token pricing yet",
      "noData": "No model data yet"
    },
    "model": "Model",
    "channels": "Channels",
    ...
    "groupsUnit": "groups",
    "bestInput": "Input price",
    "bestOutput": "Output price",
    "bestRequest": "Request price",
    "bestImage": "Image price",
    "inputShort": "In",
    "outputShort": "Out",
    "cacheShort": "Cache",
    "perRequestShort": "/ request",
    "adjustedInput": "Input after group",
    "adjustedOutput": "Output after group",
    "adjustedCacheWrite": "Cache write after group",
    "adjustedCacheRead": "Cache read after group",
    "priceBreakdownTitle": "Channel model prices",
    "priceBreakdownHint": "Shown prices come from upstream channel model pricing.",
    "upstreamPrice": "Upstream model prices",
    "upstreamPriceHint": "Direct channel model pricing before group multipliers.",
    "groupAdjustedPrice": "After group multiplier",
    "groupAdjustedHint": "Actual visible prices after multiplying upstream prices by your accessible group rates.",
    "rateFormula": "Upstream x group rate",
    "upstreamShort": "Upstream",
    "groupAdjustedShort": "Group price",
    "customRate": "Custom",
    ...
    "quickStart": "OpenAI-compatible example",
    "requestBody": "Request body",
    "curlCommand": "curl",
    "copyJson": "Copy JSON",
    "copyCurl": "Copy curl",
    "requestCopied": "Request body copied",
