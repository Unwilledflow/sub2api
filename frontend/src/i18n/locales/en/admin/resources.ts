export default {
  ...
  "adaptive": {
    ...
    "description": "Configure Adaptive parent groups and ordered leaf memberships (target 4–5 leaves; max 5 cross-leaf attempts per request)",
    "configurePool": "Configure Adaptive Pool",
    "editPool": "Edit Adaptive Pool",
    "deletePool": "Delete Adaptive Pool",
    "searchPlaceholder": "Search parent / leaf / platform...",
    "allStatus": "All Status",
    ...
    "parentGroup": "Adaptive Parent Group",
    "selectParent": "Select parent group...",
    "platformLabel": "Platform",
    "enabled": "Enable this pool",
    "enabledHelp": "When off, this parent group does not use Adaptive routing",
    "leafMembers": "Leaf Groups (priority order)",
    "addLeaf": "Add Leaf",
    "selectLeaf": "Select leaf group...",
    "leafEnabled": "Enabled",
    "leafDisabled": "Disabled",
    "noMembers": "No leaves",
    "noMembersHint": "Add at least one leaf. Order is attempt priority.",
    "leafOrderHelp": "Leaf order is the manual intelligence ranking when that pool flag is on. By default intelligence uses higher rates first and price uses lower rates first. Max 5 cross-leaf attempts. Parent and leaves must share a platform.",
    "moveUp": "Move up",
    "moveDown": "Move down",
    "hint": "The parent is the customer-facing entry; accounts and pricing come from physical leaf groups. A 15% management fee is applied at settlement.",
    "noPoolsYet": "No Adaptive pools yet",
    "createFirstPool": "Pick a parent group, attach ordered leaves, and enable managed routing.",
    "unknownGroup": "Unknown group #{id}",
    "poolSaved": "Adaptive pool saved",
    "poolUpdated": "Adaptive pool updated",
    "poolDeleted": "Adaptive pool deleted",
    "deletePoolConfirm": "Delete Adaptive config for \"{name}\" (#{id})? Physical groups are not deleted.",
    "failedToLoad": "Failed to load Adaptive pools",
    "failedToLoadGroups": "Failed to load groups",
    "failedToSave": "Failed to save Adaptive pool",
    "failedToDelete": "Failed to delete Adaptive pool"
  },
  "antiStall": {
    "title": "Anti-Stall PRO",
    "description": "Users choose Basic / Pro / Ultra (or off) on their API key page. Configure per-tier params here: hold-back buffer, slow drip on upstream interrupt, reconnect detection (exit 1 tok/s when new data arrives), and drip timeout to force leaf switch. Not competitive concurrency.",
    "openSettings": "Anti-Stall settings",
    "moduleOn": "On",
    "moduleOff": "Off",
    "save": "Save Anti-Stall settings",
    "saved": "Anti-Stall PRO settings saved",
    "failedToSave": "Failed to save Anti-Stall PRO settings",
    "moduleEnabled": "Enable Anti-Stall module globally",
    "moduleHint": "When off, no key tier is applied.",
    "enabled": "Enable Anti-Stall PRO",
    "bufferTokens": "Hold-back token count",
    "dripRate": "Drip rate while recovering (tokens/sec)",
    "upstreamMaxRetry": "Upstream retries before leaf switch",
    "lowBufferTokens": "Low-buffer threshold (allow leaf switch)",
    "maxDripSeconds": "Max drip seconds (timeout forces leaf switch)",
    "maxLeafSwitches": "Max leaf switches per request",
    "tier": {
      "basic": "Basic",
      "pro": "Pro",
      "ultra": "Ultra"
