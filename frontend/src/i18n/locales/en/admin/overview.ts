export default {
  ...
  "groups": {
    ...
    "userVisibleLabel": "User visibility",
    "userVisibleOn": "Visible to users",
    "userVisibleOff": "Hidden from users",
    "userVisibleHint": "When off, end users cannot pick this group (ideal for Adaptive leaf-only groups). Admin and routing still work."
  }
}
