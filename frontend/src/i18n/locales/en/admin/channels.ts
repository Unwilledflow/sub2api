export default {
  ...
  "channelMonitor": {
    ...
    "statusFilter": "Health",
    "statusFilterAll": "All health",
    "autoRefresh": "Auto refresh",
    "autoRefreshHint": "Silently refresh every 30s (pauses while dialogs are open)",
    "lastRefreshed": "Updated {time}",
    "runResultEmpty": "No check results",
    "noMatchTitle": "No matching monitors",
    "noMatchDescription": "Try adjusting filters or clear the health filter",
    "summary": {
      "all": "All",
      "allHint": "Total in list",
      "operational": "OK",
      "degraded": "Degraded",
      "failed": "Down",
      "unknown": "Unknown",
  ...
  "groupMonitor": {
    "title": "Group Monitor",
    "description": "Detect health of all accounts within a group",
    "createButton": "New Group Monitor",
    "createTitle": "New Group Monitor",
    "editTitle": "Edit Group Monitor",
    "runNow": "Run Now",
    "running": "Running",
    "runSuccess": "Check completed",
    "runFailed": "Check failed",
    "delete": "Delete",
    "deleteConfirm": "Delete group monitor \"{name}\"?",
    "deleteSuccess": "Group monitor deleted",
    "createSuccess": "Group monitor created",
    "updateSuccess": "Group monitor updated",
    "batchCreateSuccess": "Created {created} group monitors, skipped {skipped} already existing groups",
    "loadError": "Failed to load",
    "noMonitors": "No group monitors",
    "noMonitorsDesc": "Create a group monitor to automatically check every account in a group",
    "accounts": "Accounts",
    "healthy": "Healthy",
    "failed": "Failed",
    "unknown": "Unknown",
    ...
    "expandHint": "Click to view per-account status",
    "status": {
      "success": "Healthy",
      "failed": "Failed",
      "unknown": "Unknown"
    ...
    "form": {
      ...
      "groupHint": "{count} group(s) selected",
      "groupRequired": "Please select at least one group",
      "intervalMinutes": "Interval (minutes)",
      "intervalHint": "Range 5 - 1440 minutes",
      "modelId": "Test model",
      "modelHint": "Leave empty to auto-pick the cheapest model",
      "autoRecover": "Auto recover account on success",
