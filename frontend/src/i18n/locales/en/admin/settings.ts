export default {
  "settings": {
    ...
    "registration": {
      ...
      "emailSuffixWhitelistHint": "Only email addresses from the specified domains can register; leave empty for no restriction (for example, {'@'}qq.com, {'@'}gmail.com, *.edu.cn)",
      ...
      "emailDomainQuotaHint": "When enabled and the allowlist is not empty, every other registrable domain can register one account. When disabled, non-allowlist domains are rejected. Has no effect while the allowlist is empty",
    ...
    "payment": {
      ...
      "limitDevice": "Device",
      "limitDeviceAny": "Any",
      "limitDeviceMobile": "Mobile only",
      "limitDeviceDesktop": "Desktop only"
    },
    "balanceNotify": {
