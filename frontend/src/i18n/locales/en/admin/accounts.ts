export default {
  "accounts": {
    ...
    "openai": {
      ...
      "wsMode": "WS mode",
      "wsModeDesc": "Only applies to the current OpenAI account type; account WS modes, including http_bridge, take effect only when the global gateway.openai_ws.mode_router_v2_enabled=true.",
      "wsModeOff": "Off (off)",
    ...
    "oauth": {
      ...
      "openai": {
        ...
        "codexSessionSelectFile": "Choose JSON File",
        "codexSessionFileTooLarge": "File size must not exceed 10MB",
        "codexSessionFileEmpty": "The selected file is empty",
        "codexSessionFileReadFailed": "Failed to read the file. Please choose it again."
      },
      "grok": {
    ...
    "imageTestHint": "Calls standalone /v1/images/generations and shows the returned image below.",
    ...
    "oauthPage": {
      "title": "OpenAI OAuth Accounts",
      "description": "Manage imported OAuth accounts",
      "search": "Search by name, email, or account ID",
      ...
      "testPassed": "Passed · {latency}ms",
      "testFailed": "Failed",
      "testSkipped": "Skipped",
      "batchTestSuccess": "Batch test complete: {success} passed",
      "batchTestPartial": "Batch test complete: {success} passed, {failed} failed, {skipped} skipped",
      ...
      "shadowOf": "Shadow of account #{id}",
      "ungrouped": "Ungrouped",
      "empty": "No matching OpenAI OAuth accounts",
      "deleteConfirmTitle": "Delete OAuth Accounts",
      "deleteSingleConfirm": "Delete account \"{name}\"?",
      "deleteSelectedConfirm": "Delete the {count} selected OAuth accounts?",
      "deleteInvalidConfirm": "Delete {count} permanently invalid OAuth accounts? Temporary errors, rate limits, and policy blocks are preserved.",
      "deleteSuccess": "Deleted {count} OAuth accounts",
      "deletePartial": "Deleted {deleted}, failed {failed}, skipped {skipped}"
    }
  }
}
