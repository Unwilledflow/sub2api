export default {
  ...
  "nav": {
    ...
    "adaptiveGroups": "Adaptive Routing",
  ...
  "auth": {
    ...
    "oidc": {
      ...
      "completing": "Completing registration…",
      "completeRegistrationFailed": "Registration failed. Please check your invitation code and try again.",
      "signUp": "Continue with {providerName} to register",
      "registrationTitle": "Create an account with SSO",
      "registrationDescription": "Verify with {providerName} to create your account",
      "registrationIdentity": "Single sign-on identity"
    },
    "oauthFlow": {
