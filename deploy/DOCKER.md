...
docker run -d \
  ...
  ghcr.io/kiss-kedaya/sub2api:0.1.236
```
...
services:
  sub2api:
    image: ghcr.io/kiss-kedaya/sub2api:0.1.236
    ports:
      - "8080:8080"
    environment:
...
environment:
  ...
  SUB2API_UPDATE_HELPER_IMAGE: ghcr.io/kiss-kedaya/sub2api:0.1.236
volumes:
...
```yaml
image: ghcr.io/kiss-kedaya/sub2api:${SUB2API_VERSION:-0.1.236}
```
