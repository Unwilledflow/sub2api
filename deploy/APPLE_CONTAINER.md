...
```dotenv
APPLE_CONTAINER_SUB2API_IMAGE=ghcr.io/kiss-kedaya/sub2api:0.1.182
...
SUB2API_IMAGE=ghcr.io/kiss-kedaya/sub2api:0.1.182 # Match APPLE_CONTAINER_SUB2API_IMAGE in .env.
