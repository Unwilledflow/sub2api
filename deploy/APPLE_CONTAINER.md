...
```dotenv
APPLE_CONTAINER_SUB2API_IMAGE=ghcr.io/kiss-kedaya/sub2api:0.1.183
...
SUB2API_IMAGE=ghcr.io/kiss-kedaya/sub2api:0.1.183 # Match APPLE_CONTAINER_SUB2API_IMAGE in .env.
