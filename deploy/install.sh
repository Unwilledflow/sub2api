...
# Sub2API 安装脚本
# Usage: curl -sSL https://raw.githubusercontent.com/kiss-kedaya/sub2api/main/deploy/install.sh | bash
#
...
# Configuration
GITHUB_REPO="kiss-kedaya/sub2api"
...
Documentation=https://github.com/kiss-kedaya/sub2api
