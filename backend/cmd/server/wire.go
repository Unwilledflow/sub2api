...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	wire.Build(
		...
		wire.Bind(new(securityaudit.PromptDeleteTotpVerifier), new(*service.TotpService)),
...
func provideCleanup(
	...
	groupMonitorRunner *service.GroupMonitorRunnerService,
	adaptiveReservationReconciler *service.AdaptiveReservationReconciler,
	quotaFlusher *service.UserPlatformQuotaUsageFlusher,
	upstreamBillingProbe *service.UpstreamBillingProbeService,
	openAIPool5xxRecoveryProbe *service.OpenAIPool5xxRecoveryProbeService,
	...
	return func() {
		...
		parallelSteps := []cleanupStep{
			...
			{"GroupMonitorRunnerService", func() error {
				if groupMonitorRunner != nil {
					groupMonitorRunner.Stop()
				}
				return nil
			}},
			...
			{"OpenAIPool5xxRecoveryProbeService", func() error {
				if openAIPool5xxRecoveryProbe != nil {
					openAIPool5xxRecoveryProbe.Stop()
				}
				return nil
			}},
