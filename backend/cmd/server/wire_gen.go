...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	upstreamRouteHealth := service.ProvideUpstreamRouteHealth(configConfig)
	schedulerSnapshotService := service.ProvideSchedulerSnapshotService(schedulerCache, schedulerOutboxRepository, accountRepository, groupRepository, configConfig, upstreamRouteHealth)
	...
	openAIPool5xxCounterCache := repository.NewOpenAIPool5xxCounterCache(redisClient)
	geminiTokenCache := repository.NewGeminiTokenCache(redisClient)
	compositeTokenCacheInvalidator := service.NewCompositeTokenCacheInvalidator(geminiTokenCache)
	rateLimitService := service.ProvideRateLimitService(accountRepository, usageLogRepository, configConfig, geminiQuotaService, tempUnschedCache, timeoutCounterCache, openAI403CounterCache, openAIPool5xxCounterCache, settingService, compositeTokenCacheInvalidator)
	...
	groupMonitorService := service.ProvideGroupMonitorService(groupMonitorRepository, accountTestService, rateLimitService)
	...
	accountHealthScheduler := service.ProvideAccountHealthScheduler(accountRepository, leaderLockCache, db)
	accountHandler := admin.ProvideAccountHandler(adminService, oAuthService, openAIOAuthService, geminiOAuthService, antigravityOAuthService, grokOAuthService, rateLimitService, accountUsageService, accountTestService, concurrencyService, crsSyncService, sessionLimitCache, rpmCache, compositeTokenCacheInvalidator, grokQuotaService)
	accountHandler.SetHealthScheduler(accountHealthScheduler)
	...
	promptAdminHandler := securityaudit.NewPromptAdminHandler(promptService, totpService)
	...
	engine := server.ProvideRouter(configConfig, handlers, jwtAuthMiddleware, optionalJWTAuthMiddleware, adminAuthMiddleware, apiKeyAuthMiddleware, auditLogMiddleware, stepUpAuthMiddleware, apiKeyService, subscriptionService, opsService, settingService, db, compositeRouteResolver, redisClient)
	...
	groupMonitorRunnerService := service.ProvideGroupMonitorRunnerService(groupMonitorService, leaderLockCache, db)
	...
	channelMonitorRunner := service.ProvideChannelMonitorRunner(channelMonitorService, settingService, upstreamRouteHealth)
	channelMonitorV2Aggregator := service.ProvideChannelMonitorV2Aggregator(channelMonitorV2Repository, db, settingService)
	userPlatformQuotaUsageFlusher := service.ProvideUserPlatformQuotaUsageFlusher(configConfig, billingCache, serviceUserPlatformQuotaRepository, timingWheelService)
	openAIPool5xxRecoveryProbeService := service.ProvideOpenAIPool5xxRecoveryProbeService(accountRepository, accountTestService, tempUnschedCache, openAIPool5xxCounterCache, openAIGatewayService, leaderLockCache, configConfig)
	v := provideCleanup(client, redisClient, opsMetricsCollector, opsAggregationService, opsAlertEvaluatorService, opsCleanupService, opsScheduledReportService, opsSystemLogSink, opsService, opsIngressRejectAggregator, apiKeyService, authCacheInvalidationWorker, schedulerSnapshotService, tokenRefreshService, accountExpiryService, cnProviderBalanceCheckService, openAICodexVersionSyncService, proxyExpiryService, subscriptionExpiryService, usageCleanupService, idempotencyCleanupService, batchImageCleanupService, batchImageWorkerRuntime, pricingService, emailQueueService, billingCacheService, usageRecordWorkerPool, balancePreauthorizationRecoveryWorker, usageBalanceSettlementWorker, liveBalanceAdjustmentOutboxWorker, subscriptionService, oAuthService, openAIOAuthService, geminiOAuthService, antigravityOAuthService, grokOAuthService, openAIGatewayService, scheduledTestRunnerService, backupService, paymentOrderExpiryService, channelMonitorRunner, channelMonitorV2Aggregator, groupMonitorRunnerService, adaptiveReservationReconciler, userPlatformQuotaUsageFlusher, upstreamBillingProbeService, openAIPool5xxRecoveryProbeService, ollamaCloudUsageService, auditLogService, openAIQuotaAutoResetService, promptService, pluginManager)
