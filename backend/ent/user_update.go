...
func (_u *UserUpdate) SetAdaptiveReservedBalance(v float64) *UserUpdate {
	_u.mutation.ResetAdaptiveReservedBalance()
	_u.mutation.SetAdaptiveReservedBalance(v)
	return _u
}

// SetNillableAdaptiveReservedBalance sets the "adaptive_reserved_balance" field if the given value is not nil.
func (_u *UserUpdate) SetNillableAdaptiveReservedBalance(v *float64) *UserUpdate {
	if v != nil {
		_u.SetAdaptiveReservedBalance(*v)
	}
	return _u
}

// AddAdaptiveReservedBalance adds value to the "adaptive_reserved_balance" field.
func (_u *UserUpdate) AddAdaptiveReservedBalance(v float64) *UserUpdate {
	_u.mutation.AddAdaptiveReservedBalance(v)
	return _u
}
...
func (_u *UserUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if value, ok := _u.mutation.AdaptiveReservedBalance(); ok {
		_spec.SetField(user.FieldAdaptiveReservedBalance, field.TypeFloat64, value)
	}
	if value, ok := _u.mutation.AddedAdaptiveReservedBalance(); ok {
		_spec.AddField(user.FieldAdaptiveReservedBalance, field.TypeFloat64, value)
	}
...
// SetAdaptiveReservedBalance sets the "adaptive_reserved_balance" field.
func (_u *UserUpdateOne) SetAdaptiveReservedBalance(v float64) *UserUpdateOne {
	_u.mutation.ResetAdaptiveReservedBalance()
	_u.mutation.SetAdaptiveReservedBalance(v)
	return _u
}
...
// SetNillableAdaptiveReservedBalance sets the "adaptive_reserved_balance" field if the given value is not nil.
func (_u *UserUpdateOne) SetNillableAdaptiveReservedBalance(v *float64) *UserUpdateOne {
	if v != nil {
		_u.SetAdaptiveReservedBalance(*v)
	}
	return _u
...
// AddAdaptiveReservedBalance adds value to the "adaptive_reserved_balance" field.
func (_u *UserUpdateOne) AddAdaptiveReservedBalance(v float64) *UserUpdateOne {
	_u.mutation.AddAdaptiveReservedBalance(v)
	return _u
}
