...
func (_u *GroupUpdate) SetCompetitiveConcurrency(v bool) *GroupUpdate {
	_u.mutation.SetCompetitiveConcurrency(v)
	return _u
}

// SetNillableCompetitiveConcurrency sets the "competitive_concurrency" field if the given value is not nil.
func (_u *GroupUpdate) SetNillableCompetitiveConcurrency(v *bool) *GroupUpdate {
	if v != nil {
		_u.SetCompetitiveConcurrency(*v)
	}
	return _u
}
...
func (_u *GroupUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if value, ok := _u.mutation.CompetitiveConcurrency(); ok {
...
// SetCompetitiveConcurrency sets the "competitive_concurrency" field.
func (_u *GroupUpdateOne) SetCompetitiveConcurrency(v bool) *GroupUpdateOne {
	_u.mutation.SetCompetitiveConcurrency(v)
	return _u
}

// SetNillableCompetitiveConcurrency sets the "competitive_concurrency" field if the given value is not nil.
func (_u *GroupUpdateOne) SetNillableCompetitiveConcurrency(v *bool) *GroupUpdateOne {
	if v != nil {
		_u.SetCompetitiveConcurrency(*v)
	}
	return _u
