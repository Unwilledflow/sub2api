...
// AdaptiveReservedBalance applies equality check predicate on the "adaptive_reserved_balance" field. It's identical to AdaptiveReservedBalanceEQ.
func AdaptiveReservedBalance(v float64) predicate.User {
	return predicate.User(sql.FieldEQ(FieldAdaptiveReservedBalance, v))
}
...
// AdaptiveReservedBalanceEQ applies the EQ predicate on the "adaptive_reserved_balance" field.
func AdaptiveReservedBalanceEQ(v float64) predicate.User {
	return predicate.User(sql.FieldEQ(FieldAdaptiveReservedBalance, v))
}

// AdaptiveReservedBalanceNEQ applies the NEQ predicate on the "adaptive_reserved_balance" field.
func AdaptiveReservedBalanceNEQ(v float64) predicate.User {
	return predicate.User(sql.FieldNEQ(FieldAdaptiveReservedBalance, v))
}

// AdaptiveReservedBalanceIn applies the In predicate on the "adaptive_reserved_balance" field.
func AdaptiveReservedBalanceIn(vs ...float64) predicate.User {
	return predicate.User(sql.FieldIn(FieldAdaptiveReservedBalance, vs...))
}

// AdaptiveReservedBalanceNotIn applies the NotIn predicate on the "adaptive_reserved_balance" field.
func AdaptiveReservedBalanceNotIn(vs ...float64) predicate.User {
	return predicate.User(sql.FieldNotIn(FieldAdaptiveReservedBalance, vs...))
}

// AdaptiveReservedBalanceGT applies the GT predicate on the "adaptive_reserved_balance" field.
func AdaptiveReservedBalanceGT(v float64) predicate.User {
	return predicate.User(sql.FieldGT(FieldAdaptiveReservedBalance, v))
}

// AdaptiveReservedBalanceGTE applies the GTE predicate on the "adaptive_reserved_balance" field.
func AdaptiveReservedBalanceGTE(v float64) predicate.User {
	return predicate.User(sql.FieldGTE(FieldAdaptiveReservedBalance, v))
}

// AdaptiveReservedBalanceLT applies the LT predicate on the "adaptive_reserved_balance" field.
func AdaptiveReservedBalanceLT(v float64) predicate.User {
	return predicate.User(sql.FieldLT(FieldAdaptiveReservedBalance, v))
}

// AdaptiveReservedBalanceLTE applies the LTE predicate on the "adaptive_reserved_balance" field.
func AdaptiveReservedBalanceLTE(v float64) predicate.User {
	return predicate.User(sql.FieldLTE(FieldAdaptiveReservedBalance, v))
}
