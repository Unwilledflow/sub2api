...
const (
	...
	// FieldAdaptiveReservedBalance holds the string denoting the adaptive_reserved_balance field in the database.
	FieldAdaptiveReservedBalance = "adaptive_reserved_balance"
	...
	// FieldBalanceNotifyPrimaryEmailDisabled holds the string denoting the balance_notify_primary_email_disabled field in the database.
	FieldBalanceNotifyPrimaryEmailDisabled = "balance_notify_primary_email_disabled"
...
var Columns = []string{
	...
	FieldBalanceNotifyPrimaryEmailDisabled,
	FieldTotalRecharged,
	FieldRpmLimit,
}
...
var (
	...
	// DefaultAdaptiveReservedBalance holds the default value on creation for the "adaptive_reserved_balance" field.
	DefaultAdaptiveReservedBalance float64
	...
	// DefaultBalanceNotifyPrimaryEmailDisabled holds the default value on creation for the "balance_notify_primary_email_disabled" field.
	DefaultBalanceNotifyPrimaryEmailDisabled bool
...
// ByAdaptiveReservedBalance orders the results by the adaptive_reserved_balance field.
func ByAdaptiveReservedBalance(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldAdaptiveReservedBalance, opts...).ToFunc()
}
...
// ByBalanceNotifyPrimaryEmailDisabled orders the results by the balance_notify_primary_email_disabled field.
func ByBalanceNotifyPrimaryEmailDisabled(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldBalanceNotifyPrimaryEmailDisabled, opts...).ToFunc()
}
