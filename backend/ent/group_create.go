...
// SetCompetitiveConcurrency sets the "competitive_concurrency" field.
func (_c *GroupCreate) SetCompetitiveConcurrency(v bool) *GroupCreate {
	_c.mutation.SetCompetitiveConcurrency(v)
	return _c
}

// SetNillableCompetitiveConcurrency sets the "competitive_concurrency" field if the given value is not nil.
func (_c *GroupCreate) SetNillableCompetitiveConcurrency(v *bool) *GroupCreate {
	if v != nil {
		_c.SetCompetitiveConcurrency(*v)
	}
	return _c
}
...
func (_c *GroupCreate) defaults() error {
	...
	if _, ok := _c.mutation.CompetitiveConcurrency(); !ok {
		v := group.DefaultCompetitiveConcurrency
		_c.mutation.SetCompetitiveConcurrency(v)
	}
...
func (_c *GroupCreate) check() error {
	...
	if _, ok := _c.mutation.CompetitiveConcurrency(); !ok {
		return &ValidationError{Name: "competitive_concurrency", err: errors.New(`ent: missing required field "Group.competitive_concurrency"`)}
	}
	if _, ok := _c.mutation.PeakRateEnabled(); !ok {
...
func (_c *GroupCreate) createSpec() (*Group, *sqlgraph.CreateSpec) {
	...
	if value, ok := _c.mutation.CompetitiveConcurrency(); ok {
		_spec.SetField(group.FieldCompetitiveConcurrency, field.TypeBool, value)
		_node.CompetitiveConcurrency = value
	}
...
// SetCompetitiveConcurrency sets the "competitive_concurrency" field.
func (u *GroupUpsert) SetCompetitiveConcurrency(v bool) *GroupUpsert {
	u.Set(group.FieldCompetitiveConcurrency, v)
	return u
}

// UpdateCompetitiveConcurrency sets the "competitive_concurrency" field to the value that was provided on create.
func (u *GroupUpsert) UpdateCompetitiveConcurrency() *GroupUpsert {
	u.SetExcluded(group.FieldCompetitiveConcurrency)
	return u
}
...
// SetCompetitiveConcurrency sets the "competitive_concurrency" field.
func (u *GroupUpsertOne) SetCompetitiveConcurrency(v bool) *GroupUpsertOne {
	return u.Update(func(s *GroupUpsert) {
		s.SetCompetitiveConcurrency(v)
	})
}

// UpdateCompetitiveConcurrency sets the "competitive_concurrency" field to the value that was provided on create.
func (u *GroupUpsertOne) UpdateCompetitiveConcurrency() *GroupUpsertOne {
	return u.Update(func(s *GroupUpsert) {
		s.UpdateCompetitiveConcurrency()
	})
}
...
// SetCompetitiveConcurrency sets the "competitive_concurrency" field.
func (u *GroupUpsertBulk) SetCompetitiveConcurrency(v bool) *GroupUpsertBulk {
	return u.Update(func(s *GroupUpsert) {
		s.SetCompetitiveConcurrency(v)
	})
}
...
// UpdateCompetitiveConcurrency sets the "competitive_concurrency" field to the value that was provided on create.
func (u *GroupUpsertBulk) UpdateCompetitiveConcurrency() *GroupUpsertBulk {
	return u.Update(func(s *GroupUpsert) {
		s.UpdateCompetitiveConcurrency()
	})
}
