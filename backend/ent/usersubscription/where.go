...
// ReservedUsageUsd applies equality check predicate on the "reserved_usage_usd" field. It's identical to ReservedUsageUsdEQ.
func ReservedUsageUsd(v float64) predicate.UserSubscription {
	return predicate.UserSubscription(sql.FieldEQ(FieldReservedUsageUsd, v))
}
...
// ReservedUsageUsdEQ applies the EQ predicate on the "reserved_usage_usd" field.
func ReservedUsageUsdEQ(v float64) predicate.UserSubscription {
	return predicate.UserSubscription(sql.FieldEQ(FieldReservedUsageUsd, v))
}

// ReservedUsageUsdNEQ applies the NEQ predicate on the "reserved_usage_usd" field.
func ReservedUsageUsdNEQ(v float64) predicate.UserSubscription {
	return predicate.UserSubscription(sql.FieldNEQ(FieldReservedUsageUsd, v))
}

// ReservedUsageUsdIn applies the In predicate on the "reserved_usage_usd" field.
func ReservedUsageUsdIn(vs ...float64) predicate.UserSubscription {
	return predicate.UserSubscription(sql.FieldIn(FieldReservedUsageUsd, vs...))
}

// ReservedUsageUsdNotIn applies the NotIn predicate on the "reserved_usage_usd" field.
func ReservedUsageUsdNotIn(vs ...float64) predicate.UserSubscription {
	return predicate.UserSubscription(sql.FieldNotIn(FieldReservedUsageUsd, vs...))
}

// ReservedUsageUsdGT applies the GT predicate on the "reserved_usage_usd" field.
func ReservedUsageUsdGT(v float64) predicate.UserSubscription {
	return predicate.UserSubscription(sql.FieldGT(FieldReservedUsageUsd, v))
}

// ReservedUsageUsdGTE applies the GTE predicate on the "reserved_usage_usd" field.
func ReservedUsageUsdGTE(v float64) predicate.UserSubscription {
	return predicate.UserSubscription(sql.FieldGTE(FieldReservedUsageUsd, v))
}

// ReservedUsageUsdLT applies the LT predicate on the "reserved_usage_usd" field.
func ReservedUsageUsdLT(v float64) predicate.UserSubscription {
	return predicate.UserSubscription(sql.FieldLT(FieldReservedUsageUsd, v))
}

// ReservedUsageUsdLTE applies the LTE predicate on the "reserved_usage_usd" field.
func ReservedUsageUsdLTE(v float64) predicate.UserSubscription {
	return predicate.UserSubscription(sql.FieldLTE(FieldReservedUsageUsd, v))
}
