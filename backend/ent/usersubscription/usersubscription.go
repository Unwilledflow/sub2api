...
const (
	...
	// FieldReservedUsageUsd holds the string denoting the reserved_usage_usd field in the database.
	FieldReservedUsageUsd = "reserved_usage_usd"
...
var (
	...
	// DefaultReservedUsageUsd holds the default value on creation for the "reserved_usage_usd" field.
	DefaultReservedUsageUsd float64
...
// ByReservedUsageUsd orders the results by the reserved_usage_usd field.
func ByReservedUsageUsd(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldReservedUsageUsd, opts...).ToFunc()
}
