...
type APIKey struct {
	...
	// User-selected fallback group IDs for this API key
	...
	BlockOpenaiFast bool `json:"block_openai_fast,omitempty"`
	// Quota limit in USD for this API key (0 = unlimited)
	Quota float64 `json:"quota,omitempty"`
	// Used quota amount in USD
	QuotaUsed float64 `json:"quota_used,omitempty"`
	// Quota held by active Adaptive requests
	ReservedQuotaUsd float64 `json:"reserved_quota_usd,omitempty"`
	...
	// 5h spend held by active Adaptive requests
	ReservedUsage5hUsd float64 `json:"reserved_usage_5h_usd,omitempty"`
	// 1d spend held by active Adaptive requests
	ReservedUsage1dUsd float64 `json:"reserved_usage_1d_usd,omitempty"`
	// 7d spend held by active Adaptive requests
	ReservedUsage7dUsd float64 `json:"reserved_usage_7d_usd,omitempty"`
...
func (*APIKey) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case apikey.FieldIPWhitelist, apikey.FieldIPBlacklist, apikey.FieldFallbackGroupIds:
			values[i] = new([]byte)
		case apikey.FieldBlockOpenaiFast:
			values[i] = new(sql.NullBool)
		case apikey.FieldQuota, apikey.FieldQuotaUsed, apikey.FieldReservedQuotaUsd, apikey.FieldRateLimit5h, apikey.FieldRateLimit1d, apikey.FieldRateLimit7d, apikey.FieldUsage5h, apikey.FieldUsage1d, apikey.FieldUsage7d, apikey.FieldReservedUsage5hUsd, apikey.FieldReservedUsage1dUsd, apikey.FieldReservedUsage7dUsd:
	...
	for i := range columns {
		...
		case apikey.FieldBlockOpenaiFast:
			if value, ok := values[i].(*sql.NullBool); !ok {
				return fmt.Errorf("unexpected type %T for field block_openai_fast", values[i])
			} else if value.Valid {
				_m.BlockOpenaiFast = value.Bool
			}
		...
		case apikey.FieldReservedQuotaUsd:
			if value, ok := values[i].(*sql.NullFloat64); !ok {
				return fmt.Errorf("unexpected type %T for field reserved_quota_usd", values[i])
			} else if value.Valid {
				_m.ReservedQuotaUsd = value.Float64
			}
		...
		case apikey.FieldReservedUsage5hUsd:
			if value, ok := values[i].(*sql.NullFloat64); !ok {
				return fmt.Errorf("unexpected type %T for field reserved_usage_5h_usd", values[i])
			} else if value.Valid {
				_m.ReservedUsage5hUsd = value.Float64
			}
		case apikey.FieldReservedUsage1dUsd:
			if value, ok := values[i].(*sql.NullFloat64); !ok {
				return fmt.Errorf("unexpected type %T for field reserved_usage_1d_usd", values[i])
			} else if value.Valid {
				_m.ReservedUsage1dUsd = value.Float64
			}
		case apikey.FieldReservedUsage7dUsd:
			if value, ok := values[i].(*sql.NullFloat64); !ok {
				return fmt.Errorf("unexpected type %T for field reserved_usage_7d_usd", values[i])
			} else if value.Valid {
				_m.ReservedUsage7dUsd = value.Float64
			}
...
func (_m *APIKey) String() string {
	...
	builder.WriteString(", ")
	builder.WriteString("block_openai_fast=")
	builder.WriteString(fmt.Sprintf("%v", _m.BlockOpenaiFast))
	builder.WriteString(", ")
	...
	builder.WriteString(", ")
	builder.WriteString("reserved_quota_usd=")
	builder.WriteString(fmt.Sprintf("%v", _m.ReservedQuotaUsd))
	builder.WriteString(", ")
	...
	builder.WriteString(", ")
	builder.WriteString("reserved_usage_5h_usd=")
	builder.WriteString(fmt.Sprintf("%v", _m.ReservedUsage5hUsd))
	builder.WriteString(", ")
	builder.WriteString("reserved_usage_1d_usd=")
	builder.WriteString(fmt.Sprintf("%v", _m.ReservedUsage1dUsd))
	builder.WriteString(", ")
	builder.WriteString("reserved_usage_7d_usd=")
	builder.WriteString(fmt.Sprintf("%v", _m.ReservedUsage7dUsd))
	builder.WriteString(", ")
