...
// SetReservedUsageUsd sets the "reserved_usage_usd" field.
func (_c *UserSubscriptionCreate) SetReservedUsageUsd(v float64) *UserSubscriptionCreate {
	_c.mutation.SetReservedUsageUsd(v)
	return _c
}

// SetNillableReservedUsageUsd sets the "reserved_usage_usd" field if the given value is not nil.
func (_c *UserSubscriptionCreate) SetNillableReservedUsageUsd(v *float64) *UserSubscriptionCreate {
	if v != nil {
		_c.SetReservedUsageUsd(*v)
	}
	return _c
}
...
func (_c *UserSubscriptionCreate) defaults() error {
	...
	if _, ok := _c.mutation.ReservedUsageUsd(); !ok {
		v := usersubscription.DefaultReservedUsageUsd
		_c.mutation.SetReservedUsageUsd(v)
	}
...
func (_c *UserSubscriptionCreate) check() error {
	...
	if _, ok := _c.mutation.ReservedUsageUsd(); !ok {
		return &ValidationError{Name: "reserved_usage_usd", err: errors.New(`ent: missing required field "UserSubscription.reserved_usage_usd"`)}
	}
	if _, ok := _c.mutation.AssignedAt(); !ok {
...
func (_c *UserSubscriptionCreate) createSpec() (*UserSubscription, *sqlgraph.CreateSpec) {
	...
	if value, ok := _c.mutation.ReservedUsageUsd(); ok {
		_spec.SetField(usersubscription.FieldReservedUsageUsd, field.TypeFloat64, value)
		_node.ReservedUsageUsd = value
	}
...
// SetReservedUsageUsd sets the "reserved_usage_usd" field.
func (u *UserSubscriptionUpsert) SetReservedUsageUsd(v float64) *UserSubscriptionUpsert {
	u.Set(usersubscription.FieldReservedUsageUsd, v)
	return u
}

// UpdateReservedUsageUsd sets the "reserved_usage_usd" field to the value that was provided on create.
func (u *UserSubscriptionUpsert) UpdateReservedUsageUsd() *UserSubscriptionUpsert {
	u.SetExcluded(usersubscription.FieldReservedUsageUsd)
	return u
}

// AddReservedUsageUsd adds v to the "reserved_usage_usd" field.
func (u *UserSubscriptionUpsert) AddReservedUsageUsd(v float64) *UserSubscriptionUpsert {
	u.Add(usersubscription.FieldReservedUsageUsd, v)
	return u
}
...
// SetReservedUsageUsd sets the "reserved_usage_usd" field.
func (u *UserSubscriptionUpsertOne) SetReservedUsageUsd(v float64) *UserSubscriptionUpsertOne {
	return u.Update(func(s *UserSubscriptionUpsert) {
		s.SetReservedUsageUsd(v)
	})
}

// AddReservedUsageUsd adds v to the "reserved_usage_usd" field.
func (u *UserSubscriptionUpsertOne) AddReservedUsageUsd(v float64) *UserSubscriptionUpsertOne {
	return u.Update(func(s *UserSubscriptionUpsert) {
		s.AddReservedUsageUsd(v)
	})
}

// UpdateReservedUsageUsd sets the "reserved_usage_usd" field to the value that was provided on create.
func (u *UserSubscriptionUpsertOne) UpdateReservedUsageUsd() *UserSubscriptionUpsertOne {
	return u.Update(func(s *UserSubscriptionUpsert) {
		s.UpdateReservedUsageUsd()
	})
}
...
// SetReservedUsageUsd sets the "reserved_usage_usd" field.
func (u *UserSubscriptionUpsertBulk) SetReservedUsageUsd(v float64) *UserSubscriptionUpsertBulk {
	return u.Update(func(s *UserSubscriptionUpsert) {
		s.SetReservedUsageUsd(v)
	})
}
...
// AddReservedUsageUsd adds v to the "reserved_usage_usd" field.
func (u *UserSubscriptionUpsertBulk) AddReservedUsageUsd(v float64) *UserSubscriptionUpsertBulk {
	return u.Update(func(s *UserSubscriptionUpsert) {
		s.AddReservedUsageUsd(v)
	})
}
...
// UpdateReservedUsageUsd sets the "reserved_usage_usd" field to the value that was provided on create.
func (u *UserSubscriptionUpsertBulk) UpdateReservedUsageUsd() *UserSubscriptionUpsertBulk {
	return u.Update(func(s *UserSubscriptionUpsert) {
		s.UpdateReservedUsageUsd()
	})
}
