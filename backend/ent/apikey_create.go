...
// SetBlockOpenaiFast sets the "block_openai_fast" field.
func (_c *APIKeyCreate) SetBlockOpenaiFast(v bool) *APIKeyCreate {
	_c.mutation.SetBlockOpenaiFast(v)
	return _c
}

// SetNillableBlockOpenaiFast sets the "block_openai_fast" field if the given value is not nil.
func (_c *APIKeyCreate) SetNillableBlockOpenaiFast(v *bool) *APIKeyCreate {
	if v != nil {
		_c.SetBlockOpenaiFast(*v)
	}
	return _c
}
...
// SetReservedQuotaUsd sets the "reserved_quota_usd" field.
func (_c *APIKeyCreate) SetReservedQuotaUsd(v float64) *APIKeyCreate {
	_c.mutation.SetReservedQuotaUsd(v)
	return _c
}

// SetNillableReservedQuotaUsd sets the "reserved_quota_usd" field if the given value is not nil.
func (_c *APIKeyCreate) SetNillableReservedQuotaUsd(v *float64) *APIKeyCreate {
	if v != nil {
		_c.SetReservedQuotaUsd(*v)
	}
	return _c
}
...
// SetReservedUsage5hUsd sets the "reserved_usage_5h_usd" field.
func (_c *APIKeyCreate) SetReservedUsage5hUsd(v float64) *APIKeyCreate {
	_c.mutation.SetReservedUsage5hUsd(v)
	return _c
}

// SetNillableReservedUsage5hUsd sets the "reserved_usage_5h_usd" field if the given value is not nil.
func (_c *APIKeyCreate) SetNillableReservedUsage5hUsd(v *float64) *APIKeyCreate {
	if v != nil {
		_c.SetReservedUsage5hUsd(*v)
	}
	return _c
}

// SetReservedUsage1dUsd sets the "reserved_usage_1d_usd" field.
func (_c *APIKeyCreate) SetReservedUsage1dUsd(v float64) *APIKeyCreate {
	_c.mutation.SetReservedUsage1dUsd(v)
	return _c
}

// SetNillableReservedUsage1dUsd sets the "reserved_usage_1d_usd" field if the given value is not nil.
func (_c *APIKeyCreate) SetNillableReservedUsage1dUsd(v *float64) *APIKeyCreate {
	if v != nil {
		_c.SetReservedUsage1dUsd(*v)
	}
	return _c
}

// SetReservedUsage7dUsd sets the "reserved_usage_7d_usd" field.
func (_c *APIKeyCreate) SetReservedUsage7dUsd(v float64) *APIKeyCreate {
	_c.mutation.SetReservedUsage7dUsd(v)
	return _c
}

// SetNillableReservedUsage7dUsd sets the "reserved_usage_7d_usd" field if the given value is not nil.
func (_c *APIKeyCreate) SetNillableReservedUsage7dUsd(v *float64) *APIKeyCreate {
	if v != nil {
		_c.SetReservedUsage7dUsd(*v)
	}
	return _c
}
...
func (_c *APIKeyCreate) defaults() error {
	...
	if _, ok := _c.mutation.BlockOpenaiFast(); !ok {
		v := apikey.DefaultBlockOpenaiFast
		_c.mutation.SetBlockOpenaiFast(v)
	}
	...
	if _, ok := _c.mutation.ReservedQuotaUsd(); !ok {
		v := apikey.DefaultReservedQuotaUsd
		_c.mutation.SetReservedQuotaUsd(v)
	}
	...
	if _, ok := _c.mutation.ReservedUsage5hUsd(); !ok {
		v := apikey.DefaultReservedUsage5hUsd
		_c.mutation.SetReservedUsage5hUsd(v)
	}
	if _, ok := _c.mutation.ReservedUsage1dUsd(); !ok {
		v := apikey.DefaultReservedUsage1dUsd
		_c.mutation.SetReservedUsage1dUsd(v)
	}
	if _, ok := _c.mutation.ReservedUsage7dUsd(); !ok {
		v := apikey.DefaultReservedUsage7dUsd
		_c.mutation.SetReservedUsage7dUsd(v)
	}
	return nil
}
...
func (_c *APIKeyCreate) check() error {
	...
	if _, ok := _c.mutation.BlockOpenaiFast(); !ok {
		return &ValidationError{Name: "block_openai_fast", err: errors.New(`ent: missing required field "APIKey.block_openai_fast"`)}
	}
	if _, ok := _c.mutation.Quota(); !ok {
	...
	if _, ok := _c.mutation.ReservedQuotaUsd(); !ok {
		return &ValidationError{Name: "reserved_quota_usd", err: errors.New(`ent: missing required field "APIKey.reserved_quota_usd"`)}
	}
	if _, ok := _c.mutation.RateLimit5h(); !ok {
	...
	if _, ok := _c.mutation.ReservedUsage5hUsd(); !ok {
		return &ValidationError{Name: "reserved_usage_5h_usd", err: errors.New(`ent: missing required field "APIKey.reserved_usage_5h_usd"`)}
	}
	if _, ok := _c.mutation.ReservedUsage1dUsd(); !ok {
		return &ValidationError{Name: "reserved_usage_1d_usd", err: errors.New(`ent: missing required field "APIKey.reserved_usage_1d_usd"`)}
	}
	if _, ok := _c.mutation.ReservedUsage7dUsd(); !ok {
		return &ValidationError{Name: "reserved_usage_7d_usd", err: errors.New(`ent: missing required field "APIKey.reserved_usage_7d_usd"`)}
	}
...
func (_c *APIKeyCreate) createSpec() (*APIKey, *sqlgraph.CreateSpec) {
	...
	if value, ok := _c.mutation.BlockOpenaiFast(); ok {
		_spec.SetField(apikey.FieldBlockOpenaiFast, field.TypeBool, value)
		_node.BlockOpenaiFast = value
	}
	...
	if value, ok := _c.mutation.ReservedQuotaUsd(); ok {
		_spec.SetField(apikey.FieldReservedQuotaUsd, field.TypeFloat64, value)
		_node.ReservedQuotaUsd = value
	}
	...
	if value, ok := _c.mutation.ReservedUsage5hUsd(); ok {
		_spec.SetField(apikey.FieldReservedUsage5hUsd, field.TypeFloat64, value)
		_node.ReservedUsage5hUsd = value
	}
	if value, ok := _c.mutation.ReservedUsage1dUsd(); ok {
		_spec.SetField(apikey.FieldReservedUsage1dUsd, field.TypeFloat64, value)
		_node.ReservedUsage1dUsd = value
	}
	if value, ok := _c.mutation.ReservedUsage7dUsd(); ok {
		_spec.SetField(apikey.FieldReservedUsage7dUsd, field.TypeFloat64, value)
		_node.ReservedUsage7dUsd = value
	}
...
func (u *APIKeyUpsert) ClearFallbackGroupIds() *APIKeyUpsert {
	u.SetNull(apikey.FieldFallbackGroupIds)
	return u
}

// SetBlockOpenaiFast sets the "block_openai_fast" field.
func (u *APIKeyUpsert) SetBlockOpenaiFast(v bool) *APIKeyUpsert {
	u.Set(apikey.FieldBlockOpenaiFast, v)
	return u
}

// UpdateBlockOpenaiFast sets the "block_openai_fast" field to the value that was provided on create.
func (u *APIKeyUpsert) UpdateBlockOpenaiFast() *APIKeyUpsert {
	u.SetExcluded(apikey.FieldBlockOpenaiFast)
	return u
}
...
// SetReservedQuotaUsd sets the "reserved_quota_usd" field.
func (u *APIKeyUpsert) SetReservedQuotaUsd(v float64) *APIKeyUpsert {
	u.Set(apikey.FieldReservedQuotaUsd, v)
	return u
}

// UpdateReservedQuotaUsd sets the "reserved_quota_usd" field to the value that was provided on create.
func (u *APIKeyUpsert) UpdateReservedQuotaUsd() *APIKeyUpsert {
	u.SetExcluded(apikey.FieldReservedQuotaUsd)
	return u
}

// AddReservedQuotaUsd adds v to the "reserved_quota_usd" field.
func (u *APIKeyUpsert) AddReservedQuotaUsd(v float64) *APIKeyUpsert {
	u.Add(apikey.FieldReservedQuotaUsd, v)
	return u
}
...
// SetReservedUsage5hUsd sets the "reserved_usage_5h_usd" field.
func (u *APIKeyUpsert) SetReservedUsage5hUsd(v float64) *APIKeyUpsert {
	u.Set(apikey.FieldReservedUsage5hUsd, v)
	return u
}

// UpdateReservedUsage5hUsd sets the "reserved_usage_5h_usd" field to the value that was provided on create.
func (u *APIKeyUpsert) UpdateReservedUsage5hUsd() *APIKeyUpsert {
	u.SetExcluded(apikey.FieldReservedUsage5hUsd)
	return u
}

// AddReservedUsage5hUsd adds v to the "reserved_usage_5h_usd" field.
func (u *APIKeyUpsert) AddReservedUsage5hUsd(v float64) *APIKeyUpsert {
	u.Add(apikey.FieldReservedUsage5hUsd, v)
	return u
}

// SetReservedUsage1dUsd sets the "reserved_usage_1d_usd" field.
func (u *APIKeyUpsert) SetReservedUsage1dUsd(v float64) *APIKeyUpsert {
	u.Set(apikey.FieldReservedUsage1dUsd, v)
	return u
}

// UpdateReservedUsage1dUsd sets the "reserved_usage_1d_usd" field to the value that was provided on create.
func (u *APIKeyUpsert) UpdateReservedUsage1dUsd() *APIKeyUpsert {
	u.SetExcluded(apikey.FieldReservedUsage1dUsd)
	return u
}

// AddReservedUsage1dUsd adds v to the "reserved_usage_1d_usd" field.
func (u *APIKeyUpsert) AddReservedUsage1dUsd(v float64) *APIKeyUpsert {
	u.Add(apikey.FieldReservedUsage1dUsd, v)
	return u
}

// SetReservedUsage7dUsd sets the "reserved_usage_7d_usd" field.
func (u *APIKeyUpsert) SetReservedUsage7dUsd(v float64) *APIKeyUpsert {
	u.Set(apikey.FieldReservedUsage7dUsd, v)
	return u
}

// UpdateReservedUsage7dUsd sets the "reserved_usage_7d_usd" field to the value that was provided on create.
func (u *APIKeyUpsert) UpdateReservedUsage7dUsd() *APIKeyUpsert {
	u.SetExcluded(apikey.FieldReservedUsage7dUsd)
	return u
}

// AddReservedUsage7dUsd adds v to the "reserved_usage_7d_usd" field.
func (u *APIKeyUpsert) AddReservedUsage7dUsd(v float64) *APIKeyUpsert {
	u.Add(apikey.FieldReservedUsage7dUsd, v)
	return u
}
...
// ClearFallbackGroupIds clears the value of the "fallback_group_ids" field.
func (u *APIKeyUpsertOne) ClearFallbackGroupIds() *APIKeyUpsertOne {
	return u.Update(func(s *APIKeyUpsert) {
...
// SetBlockOpenaiFast sets the "block_openai_fast" field.
func (u *APIKeyUpsertOne) SetBlockOpenaiFast(v bool) *APIKeyUpsertOne {
	return u.Update(func(s *APIKeyUpsert) {
		s.SetBlockOpenaiFast(v)
	})
}

// UpdateBlockOpenaiFast sets the "block_openai_fast" field to the value that was provided on create.
func (u *APIKeyUpsertOne) UpdateBlockOpenaiFast() *APIKeyUpsertOne {
	return u.Update(func(s *APIKeyUpsert) {
		s.UpdateBlockOpenaiFast()
	})
}
...
// SetReservedQuotaUsd sets the "reserved_quota_usd" field.
func (u *APIKeyUpsertOne) SetReservedQuotaUsd(v float64) *APIKeyUpsertOne {
	return u.Update(func(s *APIKeyUpsert) {
		s.SetReservedQuotaUsd(v)
	})
}

// AddReservedQuotaUsd adds v to the "reserved_quota_usd" field.
func (u *APIKeyUpsertOne) AddReservedQuotaUsd(v float64) *APIKeyUpsertOne {
	return u.Update(func(s *APIKeyUpsert) {
		s.AddReservedQuotaUsd(v)
	})
}

// UpdateReservedQuotaUsd sets the "reserved_quota_usd" field to the value that was provided on create.
func (u *APIKeyUpsertOne) UpdateReservedQuotaUsd() *APIKeyUpsertOne {
	return u.Update(func(s *APIKeyUpsert) {
		s.UpdateReservedQuotaUsd()
	})
}
...
// SetReservedUsage5hUsd sets the "reserved_usage_5h_usd" field.
func (u *APIKeyUpsertOne) SetReservedUsage5hUsd(v float64) *APIKeyUpsertOne {
	return u.Update(func(s *APIKeyUpsert) {
		s.SetReservedUsage5hUsd(v)
	})
}

// AddReservedUsage5hUsd adds v to the "reserved_usage_5h_usd" field.
func (u *APIKeyUpsertOne) AddReservedUsage5hUsd(v float64) *APIKeyUpsertOne {
	return u.Update(func(s *APIKeyUpsert) {
		s.AddReservedUsage5hUsd(v)
	})
}

// UpdateReservedUsage5hUsd sets the "reserved_usage_5h_usd" field to the value that was provided on create.
func (u *APIKeyUpsertOne) UpdateReservedUsage5hUsd() *APIKeyUpsertOne {
	return u.Update(func(s *APIKeyUpsert) {
		s.UpdateReservedUsage5hUsd()
	})
}

// SetReservedUsage1dUsd sets the "reserved_usage_1d_usd" field.
func (u *APIKeyUpsertOne) SetReservedUsage1dUsd(v float64) *APIKeyUpsertOne {
	return u.Update(func(s *APIKeyUpsert) {
		s.SetReservedUsage1dUsd(v)
	})
}

// AddReservedUsage1dUsd adds v to the "reserved_usage_1d_usd" field.
func (u *APIKeyUpsertOne) AddReservedUsage1dUsd(v float64) *APIKeyUpsertOne {
	return u.Update(func(s *APIKeyUpsert) {
		s.AddReservedUsage1dUsd(v)
	})
}

// UpdateReservedUsage1dUsd sets the "reserved_usage_1d_usd" field to the value that was provided on create.
func (u *APIKeyUpsertOne) UpdateReservedUsage1dUsd() *APIKeyUpsertOne {
	return u.Update(func(s *APIKeyUpsert) {
		s.UpdateReservedUsage1dUsd()
	})
}

// SetReservedUsage7dUsd sets the "reserved_usage_7d_usd" field.
func (u *APIKeyUpsertOne) SetReservedUsage7dUsd(v float64) *APIKeyUpsertOne {
	return u.Update(func(s *APIKeyUpsert) {
		s.SetReservedUsage7dUsd(v)
	})
}

// AddReservedUsage7dUsd adds v to the "reserved_usage_7d_usd" field.
func (u *APIKeyUpsertOne) AddReservedUsage7dUsd(v float64) *APIKeyUpsertOne {
	return u.Update(func(s *APIKeyUpsert) {
		s.AddReservedUsage7dUsd(v)
	})
}

// UpdateReservedUsage7dUsd sets the "reserved_usage_7d_usd" field to the value that was provided on create.
func (u *APIKeyUpsertOne) UpdateReservedUsage7dUsd() *APIKeyUpsertOne {
	return u.Update(func(s *APIKeyUpsert) {
		s.UpdateReservedUsage7dUsd()
	})
}
...
// ClearFallbackGroupIds clears the value of the "fallback_group_ids" field.
func (u *APIKeyUpsertBulk) ClearFallbackGroupIds() *APIKeyUpsertBulk {
	return u.Update(func(s *APIKeyUpsert) {
		s.ClearFallbackGroupIds()
	})
}
...
// SetBlockOpenaiFast sets the "block_openai_fast" field.
func (u *APIKeyUpsertBulk) SetBlockOpenaiFast(v bool) *APIKeyUpsertBulk {
	return u.Update(func(s *APIKeyUpsert) {
		s.SetBlockOpenaiFast(v)
	})
}
...
// UpdateBlockOpenaiFast sets the "block_openai_fast" field to the value that was provided on create.
func (u *APIKeyUpsertBulk) UpdateBlockOpenaiFast() *APIKeyUpsertBulk {
	return u.Update(func(s *APIKeyUpsert) {
		s.UpdateBlockOpenaiFast()
	})
}
...
// SetReservedQuotaUsd sets the "reserved_quota_usd" field.
func (u *APIKeyUpsertBulk) SetReservedQuotaUsd(v float64) *APIKeyUpsertBulk {
	return u.Update(func(s *APIKeyUpsert) {
		s.SetReservedQuotaUsd(v)
	})
}
...
// AddReservedQuotaUsd adds v to the "reserved_quota_usd" field.
func (u *APIKeyUpsertBulk) AddReservedQuotaUsd(v float64) *APIKeyUpsertBulk {
	return u.Update(func(s *APIKeyUpsert) {
		s.AddReservedQuotaUsd(v)
	})
}
...
// UpdateReservedQuotaUsd sets the "reserved_quota_usd" field to the value that was provided on create.
func (u *APIKeyUpsertBulk) UpdateReservedQuotaUsd() *APIKeyUpsertBulk {
	return u.Update(func(s *APIKeyUpsert) {
		s.UpdateReservedQuotaUsd()
	})
}
...
// SetReservedUsage5hUsd sets the "reserved_usage_5h_usd" field.
func (u *APIKeyUpsertBulk) SetReservedUsage5hUsd(v float64) *APIKeyUpsertBulk {
	return u.Update(func(s *APIKeyUpsert) {
		s.SetReservedUsage5hUsd(v)
	})
}
...
// AddReservedUsage5hUsd adds v to the "reserved_usage_5h_usd" field.
func (u *APIKeyUpsertBulk) AddReservedUsage5hUsd(v float64) *APIKeyUpsertBulk {
	return u.Update(func(s *APIKeyUpsert) {
		s.AddReservedUsage5hUsd(v)
	})
}
...
// UpdateReservedUsage5hUsd sets the "reserved_usage_5h_usd" field to the value that was provided on create.
func (u *APIKeyUpsertBulk) UpdateReservedUsage5hUsd() *APIKeyUpsertBulk {
	return u.Update(func(s *APIKeyUpsert) {
		s.UpdateReservedUsage5hUsd()
	})
}
...
// SetReservedUsage1dUsd sets the "reserved_usage_1d_usd" field.
func (u *APIKeyUpsertBulk) SetReservedUsage1dUsd(v float64) *APIKeyUpsertBulk {
	return u.Update(func(s *APIKeyUpsert) {
		s.SetReservedUsage1dUsd(v)
	})
}
...
// AddReservedUsage1dUsd adds v to the "reserved_usage_1d_usd" field.
func (u *APIKeyUpsertBulk) AddReservedUsage1dUsd(v float64) *APIKeyUpsertBulk {
	return u.Update(func(s *APIKeyUpsert) {
		s.AddReservedUsage1dUsd(v)
	})
}
...
// UpdateReservedUsage1dUsd sets the "reserved_usage_1d_usd" field to the value that was provided on create.
func (u *APIKeyUpsertBulk) UpdateReservedUsage1dUsd() *APIKeyUpsertBulk {
	return u.Update(func(s *APIKeyUpsert) {
		s.UpdateReservedUsage1dUsd()
	})
}
...
// SetReservedUsage7dUsd sets the "reserved_usage_7d_usd" field.
func (u *APIKeyUpsertBulk) SetReservedUsage7dUsd(v float64) *APIKeyUpsertBulk {
	return u.Update(func(s *APIKeyUpsert) {
		s.SetReservedUsage7dUsd(v)
	})
}
...
// AddReservedUsage7dUsd adds v to the "reserved_usage_7d_usd" field.
func (u *APIKeyUpsertBulk) AddReservedUsage7dUsd(v float64) *APIKeyUpsertBulk {
	return u.Update(func(s *APIKeyUpsert) {
		s.AddReservedUsage7dUsd(v)
	})
}
...
// UpdateReservedUsage7dUsd sets the "reserved_usage_7d_usd" field to the value that was provided on create.
func (u *APIKeyUpsertBulk) UpdateReservedUsage7dUsd() *APIKeyUpsertBulk {
	return u.Update(func(s *APIKeyUpsert) {
		s.UpdateReservedUsage7dUsd()
	})
}
