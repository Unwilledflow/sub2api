...
const (
	...
	// FieldCompetitiveConcurrency holds the string denoting the competitive_concurrency field in the database.
	FieldCompetitiveConcurrency = "competitive_concurrency"
...
var (
	...
	// DefaultCompetitiveConcurrency holds the default value on creation for the "competitive_concurrency" field.
	DefaultCompetitiveConcurrency bool
...
// ByCompetitiveConcurrency orders the results by the competitive_concurrency field.
func ByCompetitiveConcurrency(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldCompetitiveConcurrency, opts...).ToFunc()
}
