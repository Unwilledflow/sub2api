...
// CompetitiveConcurrency applies equality check predicate on the "competitive_concurrency" field. It's identical to CompetitiveConcurrencyEQ.
func CompetitiveConcurrency(v bool) predicate.Group {
	return predicate.Group(sql.FieldEQ(FieldCompetitiveConcurrency, v))
}
...
// CompetitiveConcurrencyEQ applies the EQ predicate on the "competitive_concurrency" field.
func CompetitiveConcurrencyEQ(v bool) predicate.Group {
	return predicate.Group(sql.FieldEQ(FieldCompetitiveConcurrency, v))
}

// CompetitiveConcurrencyNEQ applies the NEQ predicate on the "competitive_concurrency" field.
func CompetitiveConcurrencyNEQ(v bool) predicate.Group {
	return predicate.Group(sql.FieldNEQ(FieldCompetitiveConcurrency, v))
}
