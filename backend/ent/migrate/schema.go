...
var (
	...
	APIKeysColumns = []*schema.Column{
		...
		{Name: "block_openai_fast", Type: field.TypeBool, Default: true},
		...
		{Name: "reserved_quota_usd", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(24,10)"}},
		...
		{Name: "reserved_usage_5h_usd", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(24,10)"}},
		{Name: "reserved_usage_1d_usd", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(24,10)"}},
		{Name: "reserved_usage_7d_usd", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(24,10)"}},
	...
	GroupsColumns = []*schema.Column{
		...
		{Name: "rate_multiplier", Type: field.TypeFloat64, Default: 1, SchemaType: map[string]string{"postgres": "decimal(10,4)"}},
		{Name: "competitive_concurrency", Type: field.TypeBool, Default: false},
	...
	UsageLogsColumns = []*schema.Column{
		...
		{Name: "adaptive_base_cost", Type: field.TypeFloat64, Nullable: true, SchemaType: map[string]string{"postgres": "decimal(20,10)"}},
		{Name: "adaptive_management_fee_cost", Type: field.TypeFloat64, Nullable: true, SchemaType: map[string]string{"postgres": "decimal(20,10)"}},
		{Name: "adaptive_total_cost", Type: field.TypeFloat64, Nullable: true, SchemaType: map[string]string{"postgres": "decimal(20,10)"}},
		{Name: "adaptive_uncapped_base_cost", Type: field.TypeFloat64, Nullable: true, SchemaType: map[string]string{"postgres": "decimal(20,10)"}},
		{Name: "adaptive_platform_overage_cost", Type: field.TypeFloat64, Nullable: true, SchemaType: map[string]string{"postgres": "decimal(20,10)"}},
		{Name: "adaptive_parent_group_id", Type: field.TypeInt64, Nullable: true},
		{Name: "routed_group_id", Type: field.TypeInt64, Nullable: true},
		{Name: "adaptive_attempt_no", Type: field.TypeInt, Nullable: true, SchemaType: map[string]string{"postgres": "smallint"}},
		{Name: "adaptive_pricing_snapshot_id", Type: field.TypeString, Nullable: true, Size: 128},
		{Name: "adaptive_reservation_id", Type: field.TypeString, Nullable: true, SchemaType: map[string]string{"postgres": "uuid"}},
		{Name: "adaptive_evidence_hash", Type: field.TypeString, Nullable: true, Size: 64},
		{Name: "adaptive_settlement_status", Type: field.TypeString, Nullable: true, Size: 16},
		{Name: "rate_multiplier", Type: field.TypeFloat64, Default: 1, SchemaType: map[string]string{"postgres": "decimal(10,4)"}},
	...
	UsersColumns = []*schema.Column{
		...
		{Name: "adaptive_reserved_balance", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(24,10)"}},
	...
	UserSubscriptionsColumns = []*schema.Column{
		...
		{Name: "weekly_usage_usd", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(20,10)"}},
		{Name: "monthly_usage_usd", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(20,10)"}},
		{Name: "reserved_usage_usd", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(24,10)"}},
