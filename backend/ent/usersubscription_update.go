...
func (_u *UserSubscriptionUpdate) SetReservedUsageUsd(v float64) *UserSubscriptionUpdate {
	_u.mutation.ResetReservedUsageUsd()
	_u.mutation.SetReservedUsageUsd(v)
	return _u
}

// SetNillableReservedUsageUsd sets the "reserved_usage_usd" field if the given value is not nil.
func (_u *UserSubscriptionUpdate) SetNillableReservedUsageUsd(v *float64) *UserSubscriptionUpdate {
	if v != nil {
		_u.SetReservedUsageUsd(*v)
	}
	return _u
}

// AddReservedUsageUsd adds value to the "reserved_usage_usd" field.
func (_u *UserSubscriptionUpdate) AddReservedUsageUsd(v float64) *UserSubscriptionUpdate {
	_u.mutation.AddReservedUsageUsd(v)
	return _u
}
...
func (_u *UserSubscriptionUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if value, ok := _u.mutation.ReservedUsageUsd(); ok {
		_spec.SetField(usersubscription.FieldReservedUsageUsd, field.TypeFloat64, value)
	}
	if value, ok := _u.mutation.AddedReservedUsageUsd(); ok {
		_spec.AddField(usersubscription.FieldReservedUsageUsd, field.TypeFloat64, value)
	}
...
// SetReservedUsageUsd sets the "reserved_usage_usd" field.
func (_u *UserSubscriptionUpdateOne) SetReservedUsageUsd(v float64) *UserSubscriptionUpdateOne {
	_u.mutation.ResetReservedUsageUsd()
	_u.mutation.SetReservedUsageUsd(v)
	return _u
}
...
// SetNillableReservedUsageUsd sets the "reserved_usage_usd" field if the given value is not nil.
func (_u *UserSubscriptionUpdateOne) SetNillableReservedUsageUsd(v *float64) *UserSubscriptionUpdateOne {
	if v != nil {
		_u.SetReservedUsageUsd(*v)
	}
	return _u
...
// AddReservedUsageUsd adds value to the "reserved_usage_usd" field.
func (_u *UserSubscriptionUpdateOne) AddReservedUsageUsd(v float64) *UserSubscriptionUpdateOne {
	_u.mutation.AddReservedUsageUsd(v)
	return _u
}
