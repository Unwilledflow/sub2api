...
const (
	...
	// FieldAdaptiveBaseCost holds the string denoting the adaptive_base_cost field in the database.
	FieldAdaptiveBaseCost = "adaptive_base_cost"
	// FieldAdaptiveManagementFeeCost holds the string denoting the adaptive_management_fee_cost field in the database.
	FieldAdaptiveManagementFeeCost = "adaptive_management_fee_cost"
	// FieldAdaptiveTotalCost holds the string denoting the adaptive_total_cost field in the database.
	FieldAdaptiveTotalCost = "adaptive_total_cost"
	// FieldAdaptiveUncappedBaseCost holds the string denoting the adaptive_uncapped_base_cost field in the database.
	FieldAdaptiveUncappedBaseCost = "adaptive_uncapped_base_cost"
	// FieldAdaptivePlatformOverageCost holds the string denoting the adaptive_platform_overage_cost field in the database.
	FieldAdaptivePlatformOverageCost = "adaptive_platform_overage_cost"
	// FieldAdaptiveParentGroupID holds the string denoting the adaptive_parent_group_id field in the database.
	FieldAdaptiveParentGroupID = "adaptive_parent_group_id"
	// FieldRoutedGroupID holds the string denoting the routed_group_id field in the database.
	FieldRoutedGroupID = "routed_group_id"
	// FieldAdaptiveAttemptNo holds the string denoting the adaptive_attempt_no field in the database.
	FieldAdaptiveAttemptNo = "adaptive_attempt_no"
	// FieldAdaptivePricingSnapshotID holds the string denoting the adaptive_pricing_snapshot_id field in the database.
	FieldAdaptivePricingSnapshotID = "adaptive_pricing_snapshot_id"
	// FieldAdaptiveReservationID holds the string denoting the adaptive_reservation_id field in the database.
	FieldAdaptiveReservationID = "adaptive_reservation_id"
	// FieldAdaptiveEvidenceHash holds the string denoting the adaptive_evidence_hash field in the database.
	FieldAdaptiveEvidenceHash = "adaptive_evidence_hash"
	// FieldAdaptiveSettlementStatus holds the string denoting the adaptive_settlement_status field in the database.
	FieldAdaptiveSettlementStatus = "adaptive_settlement_status"
...
var Columns = []string{
	...
	FieldTotalCost,
	FieldActualCost,
	FieldAdaptiveBaseCost,
	FieldAdaptiveManagementFeeCost,
	FieldAdaptiveTotalCost,
	FieldAdaptiveUncappedBaseCost,
	FieldAdaptivePlatformOverageCost,
	FieldAdaptiveParentGroupID,
	FieldRoutedGroupID,
	FieldAdaptiveAttemptNo,
	FieldAdaptivePricingSnapshotID,
	FieldAdaptiveReservationID,
	FieldAdaptiveEvidenceHash,
	FieldAdaptiveSettlementStatus,
	FieldRateMultiplier,
...
var (
	...
	// AdaptivePricingSnapshotIDValidator is a validator for the "adaptive_pricing_snapshot_id" field. It is called by the builders before save.
	AdaptivePricingSnapshotIDValidator func(string) error
	// AdaptiveEvidenceHashValidator is a validator for the "adaptive_evidence_hash" field. It is called by the builders before save.
	AdaptiveEvidenceHashValidator func(string) error
	// AdaptiveSettlementStatusValidator is a validator for the "adaptive_settlement_status" field. It is called by the builders before save.
	AdaptiveSettlementStatusValidator func(string) error
...
// ByAdaptiveBaseCost orders the results by the adaptive_base_cost field.
func ByAdaptiveBaseCost(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldAdaptiveBaseCost, opts...).ToFunc()
}

// ByAdaptiveManagementFeeCost orders the results by the adaptive_management_fee_cost field.
func ByAdaptiveManagementFeeCost(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldAdaptiveManagementFeeCost, opts...).ToFunc()
}

// ByAdaptiveTotalCost orders the results by the adaptive_total_cost field.
func ByAdaptiveTotalCost(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldAdaptiveTotalCost, opts...).ToFunc()
}

// ByAdaptiveUncappedBaseCost orders the results by the adaptive_uncapped_base_cost field.
func ByAdaptiveUncappedBaseCost(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldAdaptiveUncappedBaseCost, opts...).ToFunc()
}

// ByAdaptivePlatformOverageCost orders the results by the adaptive_platform_overage_cost field.
func ByAdaptivePlatformOverageCost(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldAdaptivePlatformOverageCost, opts...).ToFunc()
}

// ByAdaptiveParentGroupID orders the results by the adaptive_parent_group_id field.
func ByAdaptiveParentGroupID(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldAdaptiveParentGroupID, opts...).ToFunc()
}
...
// ByAdaptiveAttemptNo orders the results by the adaptive_attempt_no field.
func ByAdaptiveAttemptNo(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldAdaptiveAttemptNo, opts...).ToFunc()
}

// ByAdaptivePricingSnapshotID orders the results by the adaptive_pricing_snapshot_id field.
func ByAdaptivePricingSnapshotID(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldAdaptivePricingSnapshotID, opts...).ToFunc()
}

// ByAdaptiveReservationID orders the results by the adaptive_reservation_id field.
func ByAdaptiveReservationID(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldAdaptiveReservationID, opts...).ToFunc()
}

// ByAdaptiveEvidenceHash orders the results by the adaptive_evidence_hash field.
func ByAdaptiveEvidenceHash(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldAdaptiveEvidenceHash, opts...).ToFunc()
}

// ByAdaptiveSettlementStatus orders the results by the adaptive_settlement_status field.
func ByAdaptiveSettlementStatus(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldAdaptiveSettlementStatus, opts...).ToFunc()
}
