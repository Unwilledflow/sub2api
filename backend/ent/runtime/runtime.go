...
func init() {
	...
	// apikeyDescBlockOpenaiFast is the schema descriptor for block_openai_fast field.
	apikeyDescBlockOpenaiFast := apikeyFields[9].Descriptor()
	// apikey.DefaultBlockOpenaiFast holds the default value on creation for the block_openai_fast field.
	apikey.DefaultBlockOpenaiFast = apikeyDescBlockOpenaiFast.Default.(bool)
	...
	// apikeyDescReservedQuotaUsd is the schema descriptor for reserved_quota_usd field.
	apikeyDescReservedQuotaUsd := apikeyFields[12].Descriptor()
	// apikey.DefaultReservedQuotaUsd holds the default value on creation for the reserved_quota_usd field.
	apikey.DefaultReservedQuotaUsd = apikeyDescReservedQuotaUsd.Default.(float64)
	...
	// apikeyDescReservedUsage5hUsd is the schema descriptor for reserved_usage_5h_usd field.
	apikeyDescReservedUsage5hUsd := apikeyFields[20].Descriptor()
	// apikey.DefaultReservedUsage5hUsd holds the default value on creation for the reserved_usage_5h_usd field.
	apikey.DefaultReservedUsage5hUsd = apikeyDescReservedUsage5hUsd.Default.(float64)
	// apikeyDescReservedUsage1dUsd is the schema descriptor for reserved_usage_1d_usd field.
	apikeyDescReservedUsage1dUsd := apikeyFields[21].Descriptor()
	// apikey.DefaultReservedUsage1dUsd holds the default value on creation for the reserved_usage_1d_usd field.
	apikey.DefaultReservedUsage1dUsd = apikeyDescReservedUsage1dUsd.Default.(float64)
	// apikeyDescReservedUsage7dUsd is the schema descriptor for reserved_usage_7d_usd field.
	apikeyDescReservedUsage7dUsd := apikeyFields[22].Descriptor()
	// apikey.DefaultReservedUsage7dUsd holds the default value on creation for the reserved_usage_7d_usd field.
	apikey.DefaultReservedUsage7dUsd = apikeyDescReservedUsage7dUsd.Default.(float64)
	...
	adaptivegroupconfigMixin := schema.AdaptiveGroupConfig{}.Mixin()
	adaptivegroupconfigMixinFields0 := adaptivegroupconfigMixin[0].Fields()
	_ = adaptivegroupconfigMixinFields0
	adaptivegroupconfigFields := schema.AdaptiveGroupConfig{}.Fields()
	_ = adaptivegroupconfigFields
	// adaptivegroupconfigDescCreatedAt is the schema descriptor for created_at field.
	adaptivegroupconfigDescCreatedAt := adaptivegroupconfigMixinFields0[0].Descriptor()
	// adaptivegroupconfig.DefaultCreatedAt holds the default value on creation for the created_at field.
	adaptivegroupconfig.DefaultCreatedAt = adaptivegroupconfigDescCreatedAt.Default.(func() time.Time)
	// adaptivegroupconfigDescUpdatedAt is the schema descriptor for updated_at field.
	adaptivegroupconfigDescUpdatedAt := adaptivegroupconfigMixinFields0[1].Descriptor()
	// adaptivegroupconfig.DefaultUpdatedAt holds the default value on creation for the updated_at field.
	adaptivegroupconfig.DefaultUpdatedAt = adaptivegroupconfigDescUpdatedAt.Default.(func() time.Time)
	// adaptivegroupconfig.UpdateDefaultUpdatedAt holds the default value on update for the updated_at field.
	adaptivegroupconfig.UpdateDefaultUpdatedAt = adaptivegroupconfigDescUpdatedAt.UpdateDefault.(func() time.Time)
	// adaptivegroupconfigDescParentGroupID is the schema descriptor for parent_group_id field.
	adaptivegroupconfigDescParentGroupID := adaptivegroupconfigFields[0].Descriptor()
	// adaptivegroupconfig.ParentGroupIDValidator is a validator for the "parent_group_id" field. It is called by the builders before save.
	adaptivegroupconfig.ParentGroupIDValidator = adaptivegroupconfigDescParentGroupID.Validators[0].(func(int64) error)
	// adaptivegroupconfigDescEnabled is the schema descriptor for enabled field.
	adaptivegroupconfigDescEnabled := adaptivegroupconfigFields[1].Descriptor()
	// adaptivegroupconfig.DefaultEnabled holds the default value on creation for the enabled field.
	adaptivegroupconfig.DefaultEnabled = adaptivegroupconfigDescEnabled.Default.(bool)
	// adaptivegroupconfigDescConfigGeneration is the schema descriptor for config_generation field.
	adaptivegroupconfigDescConfigGeneration := adaptivegroupconfigFields[2].Descriptor()
	// adaptivegroupconfig.DefaultConfigGeneration holds the default value on creation for the config_generation field.
	adaptivegroupconfig.DefaultConfigGeneration = adaptivegroupconfigDescConfigGeneration.Default.(int64)
	// adaptivegroupconfig.ConfigGenerationValidator is a validator for the "config_generation" field. It is called by the builders before save.
	adaptivegroupconfig.ConfigGenerationValidator = adaptivegroupconfigDescConfigGeneration.Validators[0].(func(int64) error)
	adaptivegroupmembershipMixin := schema.AdaptiveGroupMembership{}.Mixin()
	adaptivegroupmembershipMixinFields0 := adaptivegroupmembershipMixin[0].Fields()
	_ = adaptivegroupmembershipMixinFields0
	adaptivegroupmembershipFields := schema.AdaptiveGroupMembership{}.Fields()
	_ = adaptivegroupmembershipFields
	// adaptivegroupmembershipDescCreatedAt is the schema descriptor for created_at field.
	adaptivegroupmembershipDescCreatedAt := adaptivegroupmembershipMixinFields0[0].Descriptor()
	// adaptivegroupmembership.DefaultCreatedAt holds the default value on creation for the created_at field.
	adaptivegroupmembership.DefaultCreatedAt = adaptivegroupmembershipDescCreatedAt.Default.(func() time.Time)
	// adaptivegroupmembershipDescUpdatedAt is the schema descriptor for updated_at field.
	adaptivegroupmembershipDescUpdatedAt := adaptivegroupmembershipMixinFields0[1].Descriptor()
	// adaptivegroupmembership.DefaultUpdatedAt holds the default value on creation for the updated_at field.
	adaptivegroupmembership.DefaultUpdatedAt = adaptivegroupmembershipDescUpdatedAt.Default.(func() time.Time)
	// adaptivegroupmembership.UpdateDefaultUpdatedAt holds the default value on update for the updated_at field.
	adaptivegroupmembership.UpdateDefaultUpdatedAt = adaptivegroupmembershipDescUpdatedAt.UpdateDefault.(func() time.Time)
	// adaptivegroupmembershipDescConfigID is the schema descriptor for config_id field.
	adaptivegroupmembershipDescConfigID := adaptivegroupmembershipFields[0].Descriptor()
	// adaptivegroupmembership.ConfigIDValidator is a validator for the "config_id" field. It is called by the builders before save.
	adaptivegroupmembership.ConfigIDValidator = adaptivegroupmembershipDescConfigID.Validators[0].(func(int64) error)
	// adaptivegroupmembershipDescLeafGroupID is the schema descriptor for leaf_group_id field.
	adaptivegroupmembershipDescLeafGroupID := adaptivegroupmembershipFields[1].Descriptor()
	// adaptivegroupmembership.LeafGroupIDValidator is a validator for the "leaf_group_id" field. It is called by the builders before save.
	adaptivegroupmembership.LeafGroupIDValidator = adaptivegroupmembershipDescLeafGroupID.Validators[0].(func(int64) error)
	// adaptivegroupmembershipDescEnabled is the schema descriptor for enabled field.
	adaptivegroupmembershipDescEnabled := adaptivegroupmembershipFields[2].Descriptor()
	// adaptivegroupmembership.DefaultEnabled holds the default value on creation for the enabled field.
	adaptivegroupmembership.DefaultEnabled = adaptivegroupmembershipDescEnabled.Default.(bool)
	// adaptivegroupmembershipDescSortOrder is the schema descriptor for sort_order field.
	adaptivegroupmembershipDescSortOrder := adaptivegroupmembershipFields[3].Descriptor()
	// adaptivegroupmembership.DefaultSortOrder holds the default value on creation for the sort_order field.
	adaptivegroupmembership.DefaultSortOrder = adaptivegroupmembershipDescSortOrder.Default.(int)
	...
	// groupDescCompetitiveConcurrency is the schema descriptor for competitive_concurrency field.
	groupDescCompetitiveConcurrency := groupFields[3].Descriptor()
	// group.DefaultCompetitiveConcurrency holds the default value on creation for the competitive_concurrency field.
	group.DefaultCompetitiveConcurrency = groupDescCompetitiveConcurrency.Default.(bool)
	...
	// usagelogDescAdaptivePricingSnapshotID is the schema descriptor for adaptive_pricing_snapshot_id field.
	usagelogDescAdaptivePricingSnapshotID := usagelogFields[35].Descriptor()
	// usagelog.AdaptivePricingSnapshotIDValidator is a validator for the "adaptive_pricing_snapshot_id" field. It is called by the builders before save.
	usagelog.AdaptivePricingSnapshotIDValidator = usagelogDescAdaptivePricingSnapshotID.Validators[0].(func(string) error)
	// usagelogDescAdaptiveEvidenceHash is the schema descriptor for adaptive_evidence_hash field.
	usagelogDescAdaptiveEvidenceHash := usagelogFields[37].Descriptor()
	// usagelog.AdaptiveEvidenceHashValidator is a validator for the "adaptive_evidence_hash" field. It is called by the builders before save.
	usagelog.AdaptiveEvidenceHashValidator = usagelogDescAdaptiveEvidenceHash.Validators[0].(func(string) error)
	// usagelogDescAdaptiveSettlementStatus is the schema descriptor for adaptive_settlement_status field.
	usagelogDescAdaptiveSettlementStatus := usagelogFields[38].Descriptor()
	// usagelog.AdaptiveSettlementStatusValidator is a validator for the "adaptive_settlement_status" field. It is called by the builders before save.
	usagelog.AdaptiveSettlementStatusValidator = usagelogDescAdaptiveSettlementStatus.Validators[0].(func(string) error)
	// usagelogDescRateMultiplier is the schema descriptor for rate_multiplier field.
	usagelogDescRateMultiplier := usagelogFields[39].Descriptor()
	...
	usagelogDescLongContextBillingApplied := usagelogFields[40].Descriptor()
	...
	// userDescAdaptiveReservedBalance is the schema descriptor for adaptive_reserved_balance field.
	userDescAdaptiveReservedBalance := userFields[4].Descriptor()
	// user.DefaultAdaptiveReservedBalance holds the default value on creation for the adaptive_reserved_balance field.
	user.DefaultAdaptiveReservedBalance = userDescAdaptiveReservedBalance.Default.(float64)
	...
	// usersubscriptionDescReservedUsageUsd is the schema descriptor for reserved_usage_usd field.
	usersubscriptionDescReservedUsageUsd := usersubscriptionFields[11].Descriptor()
	// usersubscription.DefaultReservedUsageUsd holds the default value on creation for the reserved_usage_usd field.
	usersubscription.DefaultReservedUsageUsd = usersubscriptionDescReservedUsageUsd.Default.(float64)
