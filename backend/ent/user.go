...
type User struct {
	...
	// AdaptiveReservedBalance holds the value of the "adaptive_reserved_balance" field.
	AdaptiveReservedBalance float64 `json:"adaptive_reserved_balance,omitempty"`
...
func (*User) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case user.FieldBalance, user.FieldAdaptiveReservedBalance, user.FieldFrozenBalance, user.FieldBalanceNotifyThreshold, user.FieldTotalRecharged:
...
func (_m *User) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case user.FieldAdaptiveReservedBalance:
			if value, ok := values[i].(*sql.NullFloat64); !ok {
				return fmt.Errorf("unexpected type %T for field adaptive_reserved_balance", values[i])
			} else if value.Valid {
				_m.AdaptiveReservedBalance = value.Float64
			}
...
func (_m *User) String() string {
	...
	builder.WriteString(", ")
	builder.WriteString("adaptive_reserved_balance=")
	builder.WriteString(fmt.Sprintf("%v", _m.AdaptiveReservedBalance))
	builder.WriteString(", ")
