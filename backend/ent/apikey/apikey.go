...
const (
	...
	// FieldBlockOpenaiFast holds the string denoting the block_openai_fast field in the database.
	FieldBlockOpenaiFast = "block_openai_fast"
	// FieldQuota holds the string denoting the quota field in the database.
	FieldQuota = "quota"
	// FieldQuotaUsed holds the string denoting the quota_used field in the database.
	FieldQuotaUsed = "quota_used"
	// FieldReservedQuotaUsd holds the string denoting the reserved_quota_usd field in the database.
	FieldReservedQuotaUsd = "reserved_quota_usd"
	...
	// FieldReservedUsage5hUsd holds the string denoting the reserved_usage_5h_usd field in the database.
	FieldReservedUsage5hUsd = "reserved_usage_5h_usd"
	// FieldReservedUsage1dUsd holds the string denoting the reserved_usage_1d_usd field in the database.
	FieldReservedUsage1dUsd = "reserved_usage_1d_usd"
	// FieldReservedUsage7dUsd holds the string denoting the reserved_usage_7d_usd field in the database.
	FieldReservedUsage7dUsd = "reserved_usage_7d_usd"
...
var Columns = []string{
	...
	FieldBlockOpenaiFast,
	FieldQuota,
	FieldQuotaUsed,
	FieldReservedQuotaUsd,
	FieldExpiresAt,
	FieldRateLimit5h,
	FieldRateLimit1d,
	FieldRateLimit7d,
	...
	FieldUsage1d,
	FieldUsage7d,
	FieldReservedUsage5hUsd,
	FieldReservedUsage1dUsd,
	FieldReservedUsage7dUsd,
	FieldWindow5hStart,
	FieldWindow1dStart,
	FieldWindow7dStart,
}
...
var (
	...
	// DefaultBlockOpenaiFast holds the default value on creation for the "block_openai_fast" field.
	DefaultBlockOpenaiFast bool
	// DefaultQuota holds the default value on creation for the "quota" field.
	DefaultQuota float64
	// DefaultQuotaUsed holds the default value on creation for the "quota_used" field.
	DefaultQuotaUsed float64
	// DefaultReservedQuotaUsd holds the default value on creation for the "reserved_quota_usd" field.
	DefaultReservedQuotaUsd float64
	...
	// DefaultReservedUsage5hUsd holds the default value on creation for the "reserved_usage_5h_usd" field.
	DefaultReservedUsage5hUsd float64
	// DefaultReservedUsage1dUsd holds the default value on creation for the "reserved_usage_1d_usd" field.
	DefaultReservedUsage1dUsd float64
	// DefaultReservedUsage7dUsd holds the default value on creation for the "reserved_usage_7d_usd" field.
	DefaultReservedUsage7dUsd float64
)
...
// ByBlockOpenaiFast orders the results by the block_openai_fast field.
func ByBlockOpenaiFast(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldBlockOpenaiFast, opts...).ToFunc()
}
...
// ByReservedQuotaUsd orders the results by the reserved_quota_usd field.
func ByReservedQuotaUsd(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldReservedQuotaUsd, opts...).ToFunc()
}
...
// ByReservedUsage5hUsd orders the results by the reserved_usage_5h_usd field.
func ByReservedUsage5hUsd(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldReservedUsage5hUsd, opts...).ToFunc()
}

// ByReservedUsage1dUsd orders the results by the reserved_usage_1d_usd field.
func ByReservedUsage1dUsd(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldReservedUsage1dUsd, opts...).ToFunc()
}

// ByReservedUsage7dUsd orders the results by the reserved_usage_7d_usd field.
func ByReservedUsage7dUsd(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldReservedUsage7dUsd, opts...).ToFunc()
}
