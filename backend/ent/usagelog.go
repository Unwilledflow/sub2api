...
type UsageLog struct {
	...
	// AdaptiveBaseCost holds the value of the "adaptive_base_cost" field.
	AdaptiveBaseCost *float64 `json:"adaptive_base_cost,omitempty"`
	// AdaptiveManagementFeeCost holds the value of the "adaptive_management_fee_cost" field.
	AdaptiveManagementFeeCost *float64 `json:"adaptive_management_fee_cost,omitempty"`
	// AdaptiveTotalCost holds the value of the "adaptive_total_cost" field.
	AdaptiveTotalCost *float64 `json:"adaptive_total_cost,omitempty"`
	// AdaptiveUncappedBaseCost holds the value of the "adaptive_uncapped_base_cost" field.
	AdaptiveUncappedBaseCost *float64 `json:"adaptive_uncapped_base_cost,omitempty"`
	// AdaptivePlatformOverageCost holds the value of the "adaptive_platform_overage_cost" field.
	AdaptivePlatformOverageCost *float64 `json:"adaptive_platform_overage_cost,omitempty"`
	// AdaptiveParentGroupID holds the value of the "adaptive_parent_group_id" field.
	AdaptiveParentGroupID *int64 `json:"adaptive_parent_group_id,omitempty"`
	// RoutedGroupID holds the value of the "routed_group_id" field.
	RoutedGroupID *int64 `json:"routed_group_id,omitempty"`
	// AdaptiveAttemptNo holds the value of the "adaptive_attempt_no" field.
	AdaptiveAttemptNo *int `json:"adaptive_attempt_no,omitempty"`
	// AdaptivePricingSnapshotID holds the value of the "adaptive_pricing_snapshot_id" field.
	AdaptivePricingSnapshotID *string `json:"adaptive_pricing_snapshot_id,omitempty"`
	// AdaptiveReservationID holds the value of the "adaptive_reservation_id" field.
	AdaptiveReservationID *string `json:"adaptive_reservation_id,omitempty"`
	// AdaptiveEvidenceHash holds the value of the "adaptive_evidence_hash" field.
	AdaptiveEvidenceHash *string `json:"adaptive_evidence_hash,omitempty"`
	// AdaptiveSettlementStatus holds the value of the "adaptive_settlement_status" field.
...
func (*UsageLog) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case usagelog.FieldInputCost, usagelog.FieldOutputCost, usagelog.FieldCacheCreationCost, usagelog.FieldCacheReadCost, usagelog.FieldTotalCost, usagelog.FieldActualCost, usagelog.FieldAdaptiveBaseCost, usagelog.FieldAdaptiveManagementFeeCost, usagelog.FieldAdaptiveTotalCost, usagelog.FieldAdaptiveUncappedBaseCost, usagelog.FieldAdaptivePlatformOverageCost, usagelog.FieldRateMultiplier, usagelog.FieldAccountRateMultiplier:
			values[i] = new(sql.NullFloat64)
		case usagelog.FieldID, usagelog.FieldUserID, usagelog.FieldAPIKeyID, usagelog.FieldAccountID, usagelog.FieldChannelID, usagelog.FieldGroupID, usagelog.FieldSubscriptionID, usagelog.FieldInputTokens, usagelog.FieldOutputTokens, usagelog.FieldCacheCreationTokens, usagelog.FieldCacheReadTokens, usagelog.FieldCacheCreation5mTokens, usagelog.FieldCacheCreation1hTokens, usagelog.FieldAdaptiveParentGroupID, usagelog.FieldRoutedGroupID, usagelog.FieldAdaptiveAttemptNo, usagelog.FieldBillingType, usagelog.FieldDurationMs, usagelog.FieldFirstTokenMs, usagelog.FieldImageCount, usagelog.FieldVideoCount, usagelog.FieldVideoDurationSeconds:
			values[i] = new(sql.NullInt64)
		case usagelog.FieldRequestID, usagelog.FieldModel, usagelog.FieldRequestedModel, usagelog.FieldUpstreamModel, usagelog.FieldUpstreamResponseModel, usagelog.FieldModelMappingChain, usagelog.FieldBillingTier, usagelog.FieldBillingMode, usagelog.FieldAdaptivePricingSnapshotID, usagelog.FieldAdaptiveReservationID, usagelog.FieldAdaptiveEvidenceHash, usagelog.FieldAdaptiveSettlementStatus, usagelog.FieldUserAgent, usagelog.FieldIPAddress, usagelog.FieldImageSize, usagelog.FieldImageInputSize, usagelog.FieldImageOutputSize, usagelog.FieldImageSizeSource, usagelog.FieldVideoResolution:
...
func (_m *UsageLog) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case usagelog.FieldAdaptiveBaseCost:
			if value, ok := values[i].(*sql.NullFloat64); !ok {
				return fmt.Errorf("unexpected type %T for field adaptive_base_cost", values[i])
			} else if value.Valid {
				_m.AdaptiveBaseCost = new(float64)
				*_m.AdaptiveBaseCost = value.Float64
			}
		case usagelog.FieldAdaptiveManagementFeeCost:
			if value, ok := values[i].(*sql.NullFloat64); !ok {
				return fmt.Errorf("unexpected type %T for field adaptive_management_fee_cost", values[i])
			} else if value.Valid {
				_m.AdaptiveManagementFeeCost = new(float64)
				*_m.AdaptiveManagementFeeCost = value.Float64
			}
		case usagelog.FieldAdaptiveTotalCost:
			if value, ok := values[i].(*sql.NullFloat64); !ok {
				return fmt.Errorf("unexpected type %T for field adaptive_total_cost", values[i])
			} else if value.Valid {
				_m.AdaptiveTotalCost = new(float64)
				*_m.AdaptiveTotalCost = value.Float64
			}
		case usagelog.FieldAdaptiveUncappedBaseCost:
			if value, ok := values[i].(*sql.NullFloat64); !ok {
				return fmt.Errorf("unexpected type %T for field adaptive_uncapped_base_cost", values[i])
			} else if value.Valid {
				_m.AdaptiveUncappedBaseCost = new(float64)
				*_m.AdaptiveUncappedBaseCost = value.Float64
			}
		case usagelog.FieldAdaptivePlatformOverageCost:
			if value, ok := values[i].(*sql.NullFloat64); !ok {
				return fmt.Errorf("unexpected type %T for field adaptive_platform_overage_cost", values[i])
			} else if value.Valid {
				_m.AdaptivePlatformOverageCost = new(float64)
				*_m.AdaptivePlatformOverageCost = value.Float64
			}
		case usagelog.FieldAdaptiveParentGroupID:
			if value, ok := values[i].(*sql.NullInt64); !ok {
				return fmt.Errorf("unexpected type %T for field adaptive_parent_group_id", values[i])
			} else if value.Valid {
				_m.AdaptiveParentGroupID = new(int64)
				*_m.AdaptiveParentGroupID = value.Int64
			}
		...
		case usagelog.FieldAdaptiveAttemptNo:
			if value, ok := values[i].(*sql.NullInt64); !ok {
				return fmt.Errorf("unexpected type %T for field adaptive_attempt_no", values[i])
			} else if value.Valid {
				_m.AdaptiveAttemptNo = new(int)
				*_m.AdaptiveAttemptNo = int(value.Int64)
			}
		case usagelog.FieldAdaptivePricingSnapshotID:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field adaptive_pricing_snapshot_id", values[i])
			} else if value.Valid {
				_m.AdaptivePricingSnapshotID = new(string)
				*_m.AdaptivePricingSnapshotID = value.String
			}
		case usagelog.FieldAdaptiveReservationID:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field adaptive_reservation_id", values[i])
			} else if value.Valid {
				_m.AdaptiveReservationID = new(string)
				*_m.AdaptiveReservationID = value.String
			}
		case usagelog.FieldAdaptiveEvidenceHash:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field adaptive_evidence_hash", values[i])
			} else if value.Valid {
				_m.AdaptiveEvidenceHash = new(string)
				*_m.AdaptiveEvidenceHash = value.String
			}
		case usagelog.FieldAdaptiveSettlementStatus:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field adaptive_settlement_status", values[i])
			} else if value.Valid {
				_m.AdaptiveSettlementStatus = new(string)
				*_m.AdaptiveSettlementStatus = value.String
			}
...
func (_m *UsageLog) String() string {
	...
	builder.WriteString(", ")
	if v := _m.AdaptiveBaseCost; v != nil {
		builder.WriteString("adaptive_base_cost=")
		builder.WriteString(fmt.Sprintf("%v", *v))
	}
	builder.WriteString(", ")
	if v := _m.AdaptiveManagementFeeCost; v != nil {
		builder.WriteString("adaptive_management_fee_cost=")
		builder.WriteString(fmt.Sprintf("%v", *v))
	}
	builder.WriteString(", ")
	if v := _m.AdaptiveTotalCost; v != nil {
		builder.WriteString("adaptive_total_cost=")
		builder.WriteString(fmt.Sprintf("%v", *v))
	}
	builder.WriteString(", ")
	if v := _m.AdaptiveUncappedBaseCost; v != nil {
		builder.WriteString("adaptive_uncapped_base_cost=")
		builder.WriteString(fmt.Sprintf("%v", *v))
	}
	builder.WriteString(", ")
	if v := _m.AdaptivePlatformOverageCost; v != nil {
		builder.WriteString("adaptive_platform_overage_cost=")
		builder.WriteString(fmt.Sprintf("%v", *v))
	}
	builder.WriteString(", ")
	if v := _m.AdaptiveParentGroupID; v != nil {
		builder.WriteString("adaptive_parent_group_id=")
		builder.WriteString(fmt.Sprintf("%v", *v))
	}
	builder.WriteString(", ")
	...
	builder.WriteString(", ")
	if v := _m.AdaptiveAttemptNo; v != nil {
		builder.WriteString("adaptive_attempt_no=")
		builder.WriteString(fmt.Sprintf("%v", *v))
	}
	builder.WriteString(", ")
	if v := _m.AdaptivePricingSnapshotID; v != nil {
		builder.WriteString("adaptive_pricing_snapshot_id=")
		builder.WriteString(*v)
	}
	builder.WriteString(", ")
	if v := _m.AdaptiveReservationID; v != nil {
		builder.WriteString("adaptive_reservation_id=")
		builder.WriteString(*v)
	}
	builder.WriteString(", ")
	if v := _m.AdaptiveEvidenceHash; v != nil {
		builder.WriteString("adaptive_evidence_hash=")
		builder.WriteString(*v)
	}
	builder.WriteString(", ")
	if v := _m.AdaptiveSettlementStatus; v != nil {
		builder.WriteString("adaptive_settlement_status=")
		builder.WriteString(*v)
	}
	builder.WriteString(", ")
