...
// SetAdaptiveReservedBalance sets the "adaptive_reserved_balance" field.
func (_c *UserCreate) SetAdaptiveReservedBalance(v float64) *UserCreate {
	_c.mutation.SetAdaptiveReservedBalance(v)
	return _c
}

// SetNillableAdaptiveReservedBalance sets the "adaptive_reserved_balance" field if the given value is not nil.
func (_c *UserCreate) SetNillableAdaptiveReservedBalance(v *float64) *UserCreate {
	if v != nil {
		_c.SetAdaptiveReservedBalance(*v)
	}
	return _c
}
...
func (_c *UserCreate) defaults() error {
	...
	if _, ok := _c.mutation.AdaptiveReservedBalance(); !ok {
		v := user.DefaultAdaptiveReservedBalance
		_c.mutation.SetAdaptiveReservedBalance(v)
	}
...
func (_c *UserCreate) check() error {
	...
	if _, ok := _c.mutation.AdaptiveReservedBalance(); !ok {
		return &ValidationError{Name: "adaptive_reserved_balance", err: errors.New(`ent: missing required field "User.adaptive_reserved_balance"`)}
	}
	if _, ok := _c.mutation.FrozenBalance(); !ok {
...
func (_c *UserCreate) createSpec() (*User, *sqlgraph.CreateSpec) {
	...
	if value, ok := _c.mutation.AdaptiveReservedBalance(); ok {
		_spec.SetField(user.FieldAdaptiveReservedBalance, field.TypeFloat64, value)
		_node.AdaptiveReservedBalance = value
	}
...
// SetAdaptiveReservedBalance sets the "adaptive_reserved_balance" field.
func (u *UserUpsert) SetAdaptiveReservedBalance(v float64) *UserUpsert {
	u.Set(user.FieldAdaptiveReservedBalance, v)
	return u
}

// UpdateAdaptiveReservedBalance sets the "adaptive_reserved_balance" field to the value that was provided on create.
func (u *UserUpsert) UpdateAdaptiveReservedBalance() *UserUpsert {
	u.SetExcluded(user.FieldAdaptiveReservedBalance)
	return u
}

// AddAdaptiveReservedBalance adds v to the "adaptive_reserved_balance" field.
func (u *UserUpsert) AddAdaptiveReservedBalance(v float64) *UserUpsert {
	u.Add(user.FieldAdaptiveReservedBalance, v)
	return u
}
...
// SetAdaptiveReservedBalance sets the "adaptive_reserved_balance" field.
func (u *UserUpsertOne) SetAdaptiveReservedBalance(v float64) *UserUpsertOne {
	return u.Update(func(s *UserUpsert) {
		s.SetAdaptiveReservedBalance(v)
	})
}

// AddAdaptiveReservedBalance adds v to the "adaptive_reserved_balance" field.
func (u *UserUpsertOne) AddAdaptiveReservedBalance(v float64) *UserUpsertOne {
	return u.Update(func(s *UserUpsert) {
		s.AddAdaptiveReservedBalance(v)
	})
}

// UpdateAdaptiveReservedBalance sets the "adaptive_reserved_balance" field to the value that was provided on create.
func (u *UserUpsertOne) UpdateAdaptiveReservedBalance() *UserUpsertOne {
	return u.Update(func(s *UserUpsert) {
		s.UpdateAdaptiveReservedBalance()
	})
}
...
// SetAdaptiveReservedBalance sets the "adaptive_reserved_balance" field.
func (u *UserUpsertBulk) SetAdaptiveReservedBalance(v float64) *UserUpsertBulk {
	return u.Update(func(s *UserUpsert) {
		s.SetAdaptiveReservedBalance(v)
	})
}
...
// AddAdaptiveReservedBalance adds v to the "adaptive_reserved_balance" field.
func (u *UserUpsertBulk) AddAdaptiveReservedBalance(v float64) *UserUpsertBulk {
	return u.Update(func(s *UserUpsert) {
		s.AddAdaptiveReservedBalance(v)
	})
}
...
// UpdateAdaptiveReservedBalance sets the "adaptive_reserved_balance" field to the value that was provided on create.
func (u *UserUpsertBulk) UpdateAdaptiveReservedBalance() *UserUpsertBulk {
	return u.Update(func(s *UserUpsert) {
		s.UpdateAdaptiveReservedBalance()
	})
}
