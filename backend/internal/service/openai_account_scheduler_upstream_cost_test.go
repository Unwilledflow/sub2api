...
func TestBuildOpenAISelectionOrderAlwaysIncludesCapacityOverflow(t *testing.T) {
	...
	defaultOrder := scheduler.buildOpenAISelectionOrder(OpenAIAccountScheduleRequest{}, openAIAccountLoadPlan{
		candidates: candidates,
		topK:       1,
	})
	require.Equal(t, []int64{1, 2, 3}, []int64{
		defaultOrder[0].account.ID,
		defaultOrder[1].account.ID,
		defaultOrder[2].account.ID,
	})
