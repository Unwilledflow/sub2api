...
var providerPendingOrderProtectedConfigFields = map[string]map[string]struct{}{
	payment.TypeEpusdt:    {"secretkey": {}, "pid": {}, "apibase": {}, "token": {}, "network": {}, "currency": {}, "notifyurl": {}, "returnurl": {}},
...
// running without a configured encryption key.
...
// encryptConfig serialises a provider config for storage. Configured production
// instances use AES-256-GCM; plaintext remains available for installations that
// do not have a 32-byte payment encryption key.
