...
func TestAPIKeyAuthSnapshotProfitControlRoundtrip(t *testing.T) {
	...
	require.Equal(t, 21, snapshot.Version, "v21 authentication snapshots include group long-context pricing toggle and model pricing")
	...
	require.InDelta(t, 0.012, materialized.Group.VideoModelPrices["grok-imagine-video"]["720p"], 1e-12)
