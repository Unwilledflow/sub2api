...
const (
	MonitorFailureScopeRoute   = "route"
	MonitorFailureScopeRequest = "request"
	MonitorFailureScopeModel   = "model"
)
...
type CheckResult struct {
	...
	FailureScope  string // route / request / model; empty for successful samples
	HTTPStatus    int
	LatencyMs     *int
	PingLatencyMs *int
	Message       string
