...
// AdminUserBalanceRepository exposes balance-only mutations. These operations
// intentionally do not change total_recharged; recharge accounting continues to
// use UserRepository.UpdateBalance.
type AdminUserBalanceRepository interface {
	SetBalanceByID(ctx context.Context, id int64, balance float64) (float64, error)
	AdjustBalanceByID(ctx context.Context, id int64, delta float64) (float64, error)
}
