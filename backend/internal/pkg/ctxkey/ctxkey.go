...
const (
	...
	// BlockOpenAIFast is the cached per-API-key switch used by the OpenAI gateway hot path.
	BlockOpenAIFast Key = "ctx_block_openai_fast"
	...
	// 仅用于模型级 rate limit 的端点定向豁免，不参与路由。
