...
func apiKeyAuthWithSubscription(apiKeyService *service.APIKeyService, subscriptionService *service.SubscriptionService, cfg *config.Config) gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		if apiKeyString == "" {
			// Anonymous requests without any credential material must not fill
			// the invalid-auth abuse bucket (cheap DoS amplifier).
		...
		ctx = context.WithValue(ctx, ctxkey.BlockOpenAIFast, apiKey.BlockOpenAIFast)
