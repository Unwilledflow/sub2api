...
func TestNormalizeIngressRejectIP(t *testing.T) {
	require.Equal(t, "2001:db8:abcd:1234:ffff::1", normalizeIngressRejectIP("2001:db8:abcd:1234:ffff::1"))
...
func TestLoggerRecordsIngressRejectOnce(t *testing.T) {
	...
	require.Equal(t, "2001:db8:abcd:1234:ffff::1", recorder.clientIP)
	recorder.mu.Unlock()
}
