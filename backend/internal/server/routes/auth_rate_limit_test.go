...
func TestAuthRoutesRegisterOIDCOAuthEndpoints(t *testing.T) {
	...
	for _, route := range []string{
		...
		"GET /api/v1/auth/oauth/oidc/bind/start",
		...
		require.True(t, registered[route], "missing OIDC OAuth route %s", route)
	}
}
