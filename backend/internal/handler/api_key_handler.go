...
type UpdateAPIKeyRequest struct {
	...
	AdaptiveRoutingPreference      *string   `json:"adaptive_routing_preference"`
	AdaptiveMaxRateMultiplier      *float64  `json:"adaptive_max_rate_multiplier"`
	ClearAdaptiveMaxRate           *bool     `json:"clear_adaptive_max_rate"`
	AntiStallTier                  *string   `json:"anti_stall_tier"`
	AdaptivePassiveFailoverEnabled *bool     `json:"adaptive_passive_failover_enabled"`
	BlockOpenAIFast                *bool     `json:"block_openai_fast"`
...
func (h *APIKeyHandler) Create(c *gin.Context) {
	...
	svcReq := service.CreateAPIKeyRequest{
		...
		AdaptiveRoutingPreference:      req.AdaptiveRoutingPreference,
		AdaptiveMaxRateMultiplier:      req.AdaptiveMaxRateMultiplier,
		AntiStallTier:                  req.AntiStallTier,
		AdaptivePassiveFailoverEnabled: req.AdaptivePassiveFailoverEnabled,
		BlockOpenAIFast:                blockOpenAIFastOnCreate(req.BlockOpenAIFast),
...
func blockOpenAIFastOnCreate(value *bool) bool {
	if value == nil {
		return true
	}
	return *value
...
func (h *APIKeyHandler) Update(c *gin.Context) {
	...
	if req.ClearAdaptiveMaxRate != nil {
		svcReq.ClearAdaptiveMaxRate = *req.ClearAdaptiveMaxRate
	}
	if req.Name != "" {
