...
func (h *ChannelHandler) Create(c *gin.Context) {
	...
	executeAdminIdempotentJSON(c, "admin.channels.create", req, service.DefaultWriteIdempotencyTTL(), func(ctx context.Context) (any, error) {
		channel, err := h.channelService.Create(ctx, &service.CreateChannelInput{
			Name:                       req.Name,
		...
		return channelToResponse(channel), nil
	})
}
