...
type APIKey struct {
	...
	AntiStallTier                  string     `json:"anti_stall_tier"`
...
type Group struct {
	...
	IsAdaptiveParent bool   `json:"is_adaptive_parent"`
	// UserVisible: when false, group is hidden from end-user available lists.
	UserVisible    bool    `json:"user_visible"`
	RateMultiplier float64 `json:"rate_multiplier"`
	// Adaptive parent display range across enabled leaf rates (optional).
	...
	CompetitiveConcurrency bool     `json:"competitive_concurrency"`
	Status                 string   `json:"status"`
...
type UsageLog struct {
	...
	AdaptiveBaseCost          *float64 `json:"adaptive_base_cost,omitempty"`
	AdaptiveManagementFeeCost *float64 `json:"adaptive_management_fee_cost,omitempty"`
	AdaptiveParentGroupID     *int64   `json:"adaptive_parent_group_id,omitempty"`
	RoutedGroupID             *int64   `json:"routed_group_id,omitempty"`
	AdaptiveAttemptNo         *int     `json:"adaptive_attempt_no,omitempty"`
	AdaptivePricingSnapshotID *string  `json:"adaptive_pricing_snapshot_id,omitempty"`
	AdaptiveReservationID     *string  `json:"adaptive_reservation_id,omitempty"`
	AdaptiveSettlementStatus  *string  `json:"adaptive_settlement_status,omitempty"`
	...
	// OutputTokensPerSecond is derived from complete streaming timing data.
	// It remains nullable for non-streaming and incomplete records.
	...
	Group  *Group  `json:"group,omitempty"`
	// AdaptiveParentGroup is the Adaptive parent pool when this row was adaptively routed.
	AdaptiveParentGroup *Group `json:"adaptive_parent_group,omitempty"`
	// RoutedGroup is the leaf group that actually handled the request.
	RoutedGroup  *Group            `json:"routed_group,omitempty"`
...
type AdminUsageLog struct {
	...
	// UpstreamModelMismatch is true when the upstream response model differs from the sent model.
