...
func TestPrepareUsageLogInsert_SessionIDArgWiring(t *testing.T) {
	require.Len(t, usageLogInsertArgTypes, 69, "arg-type table must include adaptive fields and session_id")
	...
	// created_at is last; session_id follows the Adaptive settlement fields.
