...
// IncrementUsage records delivered usage. Admission checks and reservation
// holds happen before forwarding; post-delivery accounting never rejects a
// request merely because a concurrent hold changed available headroom.
