...
func TestScanUsageLogRequestTypeAndLegacyFallback(t *testing.T) {
	...
	t.Run("service_tier_is_scanned", func(t *testing.T) {
		...
		log, err := scanUsageLog(usageLogScannerStub{values: []any{
			...
			sql.NullString{},  // billing_mode
			sql.NullFloat64{}, // account_stats_cost
			sql.NullFloat64{Valid: true, Float64: 0.8},  // adaptive_base_cost
			sql.NullFloat64{Valid: true, Float64: 0.12}, // adaptive_management_fee_cost
			sql.NullFloat64{Valid: true, Float64: 0.92}, // adaptive_total_cost
			sql.NullFloat64{Valid: true, Float64: 1.2},  // adaptive_uncapped_base_cost
			sql.NullFloat64{Valid: true, Float64: 0.4},  // adaptive_platform_overage_cost
			sql.NullInt64{Valid: true, Int64: 101},      // adaptive_parent_group_id
			sql.NullInt64{Valid: true, Int64: 202},      // routed_group_id
			sql.NullInt64{Valid: true, Int64: 2},        // adaptive_attempt_no
			sql.NullString{Valid: true, String: "pricing-42"},    // adaptive_pricing_snapshot_id
			sql.NullString{Valid: true, String: "reservation-7"}, // adaptive_reservation_id
			sql.NullString{Valid: true, String: "evidence-7"},    // adaptive_evidence_hash
			sql.NullString{Valid: true, String: "captured"},      // adaptive_settlement_status
			sql.NullString{},  // session_id
			now,
		}})
		require.NoError(t, err)
