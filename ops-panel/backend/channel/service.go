...
func (s *Service) Create(in CreateInput) (*storage.Channel, error) {
	...
	c := &storage.Channel{
		Name:                        in.Name,
		AllocationGroup:             normalizeAllocationGroup(in.AllocationGroup),
		Type:                        in.Type,
		SiteURL:                     in.SiteURL,
...
func (s *Service) Update(id uint, in UpdateInput) (*storage.Channel, error) {
	...
	if in.AllocationGroup != nil {
		c.AllocationGroup = normalizeAllocationGroup(*in.AllocationGroup)
	}
	if in.SiteURL != nil {
	...
	if in.SelfOperated != nil {
		c.SelfOperated = *in.SelfOperated
	}
...
func normalizeAllocationGroup(v string) string {
