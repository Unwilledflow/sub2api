...
import { AutomationSettings } from "@/components/operations/automation-settings";
import { TargetAnnouncementSettings } from "@/components/operations/target-announcement-settings";
import { TargetSettings } from "@/components/operations/target-settings";
  ...
  return (
    <section className="space-y-4">
      ...
      <Tabs
        value={activeTab}
        onValueChange={(value) => {
          const tab = settingsTabs.find((candidate) => candidate === value);
          if (tab) setActiveTab(tab);
        }}
        className="space-y-4"
      >
        <TabsList className="h-auto w-full justify-start overflow-x-auto rounded-2xl border border-border bg-muted/40 p-1">
          <TabsTrigger value="system" className="flex-none px-4 py-2">
            系统设置
          </TabsTrigger>
          <TabsTrigger value="notifications" className="flex-none px-4 py-2">
            通知渠道
          </TabsTrigger>
          <TabsTrigger value="captcha" className="flex-none px-4 py-2">
            验证码服务
          </TabsTrigger>
          <TabsTrigger value="target" className="flex-none px-4 py-2">
            目标服务
          </TabsTrigger>
          <TabsTrigger value="upstream-sync" className="flex-none px-4 py-2">
            上游动态同步
          </TabsTrigger>
          <TabsTrigger value="automation" className="flex-none px-4 py-2">
            目标自动化
          </TabsTrigger>
          <TabsTrigger value="target-announcements" className="flex-none px-4 py-2">
            目标公告
          </TabsTrigger>
        </TabsList>
        ...
        <TabsContent value="target-announcements">
          <TargetAnnouncementSettings />
        </TabsContent>
      </Tabs>
